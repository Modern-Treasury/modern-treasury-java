...
dependencies {
    testImplementation(project(":modern-treasury-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../modern-treasury-java-core/src/main/resources/META-INF/proguard/modern-treasury-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../modern-treasury-java-core/src/main/resources/META-INF/proguard/modern-treasury-java-core.pro",
