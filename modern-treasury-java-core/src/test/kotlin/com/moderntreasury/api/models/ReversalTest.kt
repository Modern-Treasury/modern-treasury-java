...
internal class ReversalTest {
    ...
    fun create() {
        ...
        assertThat(reversal.internalAccountId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(reversal.ledgerTransactionId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(reversal.paymentOrderId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
