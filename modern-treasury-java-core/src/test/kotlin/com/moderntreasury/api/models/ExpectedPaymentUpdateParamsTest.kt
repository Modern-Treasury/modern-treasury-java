...
internal class ExpectedPaymentUpdateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.amountReconciledDirection()).contains(ExpectedPaymentUpdateParams.AmountReconciledDirection.CREDIT)
      assertThat(body.amountUnreconciled()).contains(0L)
      assertThat(body.amountUnreconciledDirection()).contains(ExpectedPaymentUpdateParams.AmountUnreconciledDirection.CREDIT)
      ...
      assertThat(body.metadata()).contains(ExpectedPaymentUpdateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(body.reconciliationRuleVariables().getOrNull()).containsExactly(ReconciliationRule.builder()
          .amountLowerBound(0L)
          .amountUpperBound(0L)
          .direction(ReconciliationRule.Direction.CREDIT)
          .internalAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
