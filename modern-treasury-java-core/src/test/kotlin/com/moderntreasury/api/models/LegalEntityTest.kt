...
internal class LegalEntityTest {
    ...
    fun create() {
      ...
      assertThat(legalEntity.addresses()).containsExactly(LegalEntity.LegalEntityAddress.builder()
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(legalEntity.bankSettings()).contains(BankSettings.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .backupWithholdingPercentage(0L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .discardedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(legalEntity.discardedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(legalEntity.regulators().getOrNull()).containsExactly(LegalEntity.LegalEntityRegulator.builder()
          .jurisdiction("jurisdiction")
          .name("name")
          .registrationNumber("registration_number")
          .build())
      assertThat(legalEntity.riskRating()).contains(LegalEntity.RiskRating.LOW)
      assertThat(legalEntity.serviceProviderLegalEntityId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(legalEntity.status()).contains(LegalEntity.Status.ACTIVE)
      assertThat(legalEntity.suffix()).contains("suffix")
      assertThat(legalEntity.termsOfUse()).contains(LegalEntity.TermsOfUse.builder()
          .acceptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .ipAddress("ip_address")
          .build())
      assertThat(legalEntity.thirdPartyVerification()).contains(ThirdPartyVerification.builder()
          .outcome(ThirdPartyVerification.Outcome.PASSED)
          .vendor(ThirdPartyVerification.Vendor.PERSONA)
          .vendorVerificationId("vendor_verification_id")
          .verificationCategory(ThirdPartyVerification.VerificationCategory.LEGAL_NAME)
      ...
      assertThat(legalEntity.wealthAndEmploymentDetails()).contains(WealthAndEmploymentDetails.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .annualIncome(0L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .discardedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(legalEntity.legalEntityAssociations().getOrNull()).containsExactly(LegalEntityAssociation.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .childLegalEntity(ChildLegalEntity.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .addAddress(ChildLegalEntity.LegalEntityAddress.builder()
