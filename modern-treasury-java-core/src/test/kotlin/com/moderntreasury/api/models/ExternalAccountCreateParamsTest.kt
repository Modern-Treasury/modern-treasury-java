...
internal class ExternalAccountCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.accountDetails().getOrNull()).containsExactly(ExternalAccountCreateParams.AccountDetail.builder()
          .accountNumber("account_number")
          .accountNumberType(ExternalAccountCreateParams.AccountDetail.AccountNumberType.AU_NUMBER)
          .build())
      assertThat(body.accountType()).contains(ExternalAccountType.BASE_WALLET)
      assertThat(body.contactDetails().getOrNull()).containsExactly(ContactDetailCreateRequest.builder()
          .contactIdentifier("contact_identifier")
          .contactIdentifierType(ContactDetailCreateRequest.ContactIdentifierType.EMAIL)
          .build())
      ...
      assertThat(body.ledgerAccount()).contains(LedgerAccountCreateRequest.builder()
          ...
          .metadata(LedgerAccountCreateRequest.Metadata.builder()
              ...
              .build())
          .build())
      assertThat(body.metadata()).contains(ExternalAccountCreateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(body.routingDetails().getOrNull()).containsExactly(ExternalAccountCreateParams.RoutingDetail.builder()
          .routingNumber("routing_number")
          .routingNumberType(ExternalAccountCreateParams.RoutingDetail.RoutingNumberType.ABA)
          .paymentType(ExternalAccountCreateParams.RoutingDetail.PaymentType.ACH)
          .build())
