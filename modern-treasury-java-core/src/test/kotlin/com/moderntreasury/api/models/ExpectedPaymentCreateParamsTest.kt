...
internal class ExpectedPaymentCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.amountReconciledDirection()).contains(ExpectedPaymentCreateParams.AmountReconciledDirection.CREDIT)
      assertThat(body.amountUnreconciled()).contains(0L)
      assertThat(body.amountUnreconciledDirection()).contains(ExpectedPaymentCreateParams.AmountUnreconciledDirection.CREDIT)
      ...
      assertThat(body.lineItems().getOrNull()).containsExactly(ExpectedPaymentCreateParams.LineItemRequest.builder()
          .amount(0L)
          .accountingCategoryId("accounting_category_id")
          .description("description")
          .metadata(ExpectedPaymentCreateParams.LineItemRequest.Metadata.builder()
              ...
              .build())
          .build())
      assertThat(body.metadata()).contains(ExpectedPaymentCreateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
