...
class LedgerAccountPayoutTest {
    ...
    fun createLedgerAccountPayout() {
        ...
        assertThat(ledgerAccountPayout.amount()).contains(123L)
        assertThat(ledgerAccountPayout.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(ledgerAccountPayout.currency()).isEqualTo("string")
        assertThat(ledgerAccountPayout.currencyExponent()).contains(123L)
        assertThat(ledgerAccountPayout.description()).contains("string")
        ...
        assertThat(ledgerAccountPayout.payoutEntryDirection()).contains("string")
