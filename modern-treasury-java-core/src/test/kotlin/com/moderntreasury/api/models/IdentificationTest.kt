...
internal class IdentificationTest {
    ...
    fun create() {
        ...
        assertThat(identification.expirationDate()).contains(LocalDate.parse("2019-12-27"))
        assertThat(identification.idType()).isEqualTo(Identification.IdType.AR_CUIL)
        assertThat(identification.issuingCountry()).contains("issuing_country")
        assertThat(identification.issuingRegion()).contains("issuing_region")
