...
class LedgerTransactionTest {
    ...
    fun createLedgerTransaction() {
        ...
        assertThat(ledgerTransaction.reversedByLedgerTransactionId()).contains("string")
        assertThat(ledgerTransaction.reversesLedgerTransactionId()).contains("string")
