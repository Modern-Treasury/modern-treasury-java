...
internal class PaymentOrderAsyncCreateTest {
    ...
    fun create() {
        ...
        assertThat(paymentOrderAsyncCreate.chargeBearer())
            .contains(PaymentOrderAsyncCreate.ChargeBearer.SHARED)
        assertThat(paymentOrderAsyncCreate.currency()).contains(Currency.AED)
        assertThat(paymentOrderAsyncCreate.description()).contains("description")
        assertThat(paymentOrderAsyncCreate.effectiveDate()).contains(LocalDate.parse("2019-12-27"))
        assertThat(paymentOrderAsyncCreate.expiresAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(paymentOrderAsyncCreate.fallbackType())
            .contains(PaymentOrderAsyncCreate.FallbackType.ACH)
        ...
        assertThat(paymentOrderAsyncCreate.foreignExchangeIndicator())
            .contains(PaymentOrderAsyncCreate.ForeignExchangeIndicator.FIXED_TO_VARIABLE)
        ...
        assertThat(paymentOrderAsyncCreate.ledgerTransactionId())
            .contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(paymentOrderAsyncCreate.lineItems().getOrNull())
            .containsExactly(
                LineItem.builder()
                    .amount(0L)
                    .accountingCategoryId("accounting_category_id")
        ...
        assertThat(paymentOrderAsyncCreate.nsfProtected()).contains(true)
        assertThat(paymentOrderAsyncCreate.originatingPartyName())
            .contains("originating_party_name")
        assertThat(paymentOrderAsyncCreate.priority())
            .contains(PaymentOrderAsyncCreate.Priority.HIGH)
        assertThat(paymentOrderAsyncCreate.processAfter())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(paymentOrderAsyncCreate.purpose()).contains("purpose")
        ...
        assertThat(paymentOrderAsyncCreate.reconciliationStatus())
            .contains(PaymentOrderAsyncCreate.ReconciliationStatus.UNRECONCILED)
        assertThat(paymentOrderAsyncCreate.remittanceInformation())
            .contains("remittance_information")
        assertThat(paymentOrderAsyncCreate.sendRemittanceAdvice()).contains(true)
        assertThat(paymentOrderAsyncCreate.statementDescriptor()).contains("statement_descriptor")
        assertThat(paymentOrderAsyncCreate.subtype())
            .contains(PaymentOrderSubtype.BACS_NEW_INSTRUCTION)
        assertThat(paymentOrderAsyncCreate.transactionMonitoringEnabled()).contains(true)
