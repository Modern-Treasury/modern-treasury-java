...
internal class RoutingDetailTest {
    ...
    fun create() {
      ...
      assertThat(routingDetail.bankAddress()).contains(Address.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .country("country")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .line1("line1")
      ...
      assertThat(routingDetail.discardedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
