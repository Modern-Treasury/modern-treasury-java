...
internal class InvoiceUpdateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.contactDetails().getOrNull()).containsExactly(ContactDetail.builder()
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(body.counterpartyBillingAddress()).contains(InvoiceUpdateParams.CounterpartyBillingAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
      ...
      assertThat(body.counterpartyShippingAddress()).contains(InvoiceUpdateParams.CounterpartyShippingAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
      ...
      assertThat(body.invoiceLineItems().getOrNull()).containsExactly(InvoiceUpdateParams.InvoiceLineItemCreateRequest.builder()
          .name("name")
          .unitAmount(0L)
          .description("description")
          .direction("direction")
          ...
          .unitAmountDecimal("unit_amount_decimal")
          .build())
      assertThat(body.invoicerAddress()).contains(InvoiceUpdateParams.InvoicerAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
