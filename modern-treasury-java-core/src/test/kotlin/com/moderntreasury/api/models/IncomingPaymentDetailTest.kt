...
internal class IncomingPaymentDetailTest {
    ...
    fun create() {
        ...
        assertThat(incomingPaymentDetail.originatingAccountNumberSafe())
            .contains("originating_account_number_safe")
        assertThat(incomingPaymentDetail.originatingAccountNumberType())
            .contains(IncomingPaymentDetail.OriginatingAccountNumberType.ARBITRUM_ADDRESS)
        assertThat(incomingPaymentDetail.originatingRoutingNumber())
            .contains("originating_routing_number")
        ...
        assertThat(incomingPaymentDetail.originatingAccountNumber())
            .contains("originating_account_number")
        ...
        assertThat(incomingPaymentDetail.originatingPartyVendorIdentifier())
            .contains("originating_party_vendor_identifier")
        assertThat(incomingPaymentDetail.receivingAccountNumber())
            .contains("receiving_account_number")
        assertThat(incomingPaymentDetail.receivingAccountNumberSafe())
            .contains("receiving_account_number_safe")
    }
