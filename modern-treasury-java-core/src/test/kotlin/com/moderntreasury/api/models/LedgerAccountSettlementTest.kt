...
class LedgerAccountSettlementTest {
    ...
    fun createLedgerAccountSettlement() {
        ...
        assertThat(ledgerAccountSettlement.amount()).contains(123L)
        ...
        assertThat(ledgerAccountSettlement.currencyExponent()).contains(123L)
        assertThat(ledgerAccountSettlement.description()).contains("string")
        ...
        assertThat(ledgerAccountSettlement.settledLedgerAccountId())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(ledgerAccountSettlement.settlementEntryDirection()).contains("string")
