...
internal class TransactionLineItemTest {
    ...
    fun create() {
      ...
      assertThat(transactionLineItem.counterpartyId()).contains("counterparty_id")
      ...
      assertThat(transactionLineItem.discardedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(transactionLineItem.expectedPaymentId()).contains("expected_payment_id")
      ...
      assertThat(transactionLineItem.reconciliationGroupId()).contains("reconciliation_group_id")
      assertThat(transactionLineItem.transactableId()).contains("transactable_id")
      assertThat(transactionLineItem.transactableType()).contains(TransactionLineItem.TransactableType.INCOMING_PAYMENT_DETAIL)
