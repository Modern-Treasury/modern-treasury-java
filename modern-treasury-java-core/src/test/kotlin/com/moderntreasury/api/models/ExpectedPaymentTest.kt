...
internal class ExpectedPaymentTest {
    ...
    fun create() {
      ...
      assertThat(expectedPayment.amountReconciled()).contains(0L)
      assertThat(expectedPayment.amountReconciledDirection()).contains(ExpectedPayment.AmountReconciledDirection.CREDIT)
      assertThat(expectedPayment.amountUnreconciled()).contains(0L)
      assertThat(expectedPayment.amountUnreconciledDirection()).contains(ExpectedPayment.AmountUnreconciledDirection.CREDIT)
      assertThat(expectedPayment.amountUpperBound()).contains(0L)
      assertThat(expectedPayment.counterpartyId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(expectedPayment.internalAccountId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(expectedPayment.ledgerTransactionId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(expectedPayment.reconciliationMethod()).contains(ExpectedPayment.ReconciliationMethod.AUTOMATIC)
      assertThat(expectedPayment.reconciliationRuleVariables().getOrNull()).containsExactly(ReconciliationRule.builder()
          .amountLowerBound(0L)
          .amountUpperBound(0L)
          .direction(ReconciliationRule.Direction.CREDIT)
          .internalAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(expectedPayment.transactionLineItemId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
