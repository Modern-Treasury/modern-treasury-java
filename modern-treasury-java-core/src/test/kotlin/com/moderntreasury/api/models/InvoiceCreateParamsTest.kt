...
internal class InvoiceCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.contactDetails().getOrNull()).containsExactly(ContactDetail.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .contactIdentifier("contact_identifier")
          .contactIdentifierType(ContactDetail.ContactIdentifierType.EMAIL)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(body.counterpartyBillingAddress()).contains(InvoiceCreateParams.CounterpartyBillingAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
          ...
          .line2("line2")
          .build())
      assertThat(body.counterpartyShippingAddress()).contains(InvoiceCreateParams.CounterpartyShippingAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
      ...
      assertThat(body.invoiceLineItems().getOrNull()).containsExactly(InvoiceCreateParams.InvoiceLineItemCreateRequest.builder()
          .name("name")
          .unitAmount(0L)
          .description("description")
          .direction("direction")
          ...
          .unitAmountDecimal("unit_amount_decimal")
          .build())
      assertThat(body.invoicerAddress()).contains(InvoiceCreateParams.InvoicerAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
