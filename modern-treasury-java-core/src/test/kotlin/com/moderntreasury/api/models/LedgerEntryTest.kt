...
internal class LedgerEntryTest {
    ...
    fun create() {
      ...
      assertThat(ledgerEntry.discardedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(ledgerEntry.resultingLedgerAccountBalances()).contains(LedgerBalances.builder()
          .availableBalance(LedgerBalance.builder()
              .amount(0L)
              .amountString("amount_string")
              .credits(0L)
