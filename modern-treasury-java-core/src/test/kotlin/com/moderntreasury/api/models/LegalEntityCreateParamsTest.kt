...
internal class LegalEntityCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.addresses().getOrNull()).containsExactly(LegalEntityAddressCreateRequest.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
          ...
          .primary(true)
          .build())
      assertThat(body.bankSettings()).contains(BankSettings.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .backupWithholdingPercentage(0L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .discardedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(body.documents().getOrNull()).containsExactly(LegalEntityCreateParams.Document.builder()
          .documentType(LegalEntityCreateParams.Document.DocumentType.ARTICLES_OF_INCORPORATION)
          .fileData("file_data")
          .filename("filename")
          .build())
      ...
      assertThat(body.identifications().getOrNull()).containsExactly(IdentificationCreateRequest.builder()
          .idNumber("id_number")
          .idType(IdentificationCreateRequest.IdType.AR_CUIL)
          .addDocument(IdentificationCreateRequest.Document.builder()
              .documentType(IdentificationCreateRequest.Document.DocumentType.ARTICLES_OF_INCORPORATION)
          ...
          .issuingRegion("issuing_region")
          .build())
      assertThat(body.industryClassifications().getOrNull()).containsExactly(LegalEntityIndustryClassification.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addClassificationCode("string")
          .classificationType(LegalEntityIndustryClassification.ClassificationType.ANZSIC)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(body.legalEntityAssociations().getOrNull()).containsExactly(LegalEntityAssociationInlineCreate.builder()
          .addRelationshipType(LegalEntityAssociationInlineCreate.RelationshipType.AUTHORIZED_SIGNER)
          .childLegalEntity(ChildLegalEntityCreate.builder()
              .addAddress(LegalEntityAddressCreateRequest.builder()
                  .country("country")
          ...
          .title("title")
          .build())
      assertThat(body.legalStructure()).contains(LegalEntityCreateParams.LegalStructure.CORPORATION)
      assertThat(body.listedExchange()).contains("listed_exchange")
      assertThat(body.metadata()).contains(LegalEntityCreateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(body.phoneNumbers().getOrNull()).containsExactly(LegalEntityCreateParams.PhoneNumber.builder()
          .phoneNumber("phone_number")
          .build())
      ...
      assertThat(body.regulators().getOrNull()).containsExactly(LegalEntityCreateParams.LegalEntityRegulator.builder()
          .jurisdiction("jurisdiction")
          .name("name")
          .registrationNumber("registration_number")
          .build())
      assertThat(body.riskRating()).contains(LegalEntityCreateParams.RiskRating.LOW)
      assertThat(body.serviceProviderLegalEntityId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(body.suffix()).contains("suffix")
      assertThat(body.termsOfUse()).contains(LegalEntityCreateParams.TermsOfUse.builder()
          .acceptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .ipAddress("ip_address")
          .build())
      assertThat(body.thirdPartyVerification()).contains(ThirdPartyVerification.builder()
          .outcome(ThirdPartyVerification.Outcome.PASSED)
          .vendor(ThirdPartyVerification.Vendor.PERSONA)
          .vendorVerificationId("vendor_verification_id")
          .verificationCategory(ThirdPartyVerification.VerificationCategory.LEGAL_NAME)
          ...
          .comment("comment")
          .build())
      assertThat(body.thirdPartyVerifications().getOrNull()).containsExactly(ThirdPartyVerification.builder()
          .outcome(ThirdPartyVerification.Outcome.PASSED)
          .vendor(ThirdPartyVerification.Vendor.PERSONA)
          .vendorVerificationId("vendor_verification_id")
          .verificationCategory(ThirdPartyVerification.VerificationCategory.LEGAL_NAME)
      ...
      assertThat(body.wealthAndEmploymentDetails()).contains(WealthAndEmploymentDetails.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .annualIncome(0L)
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .discardedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
