...
class LedgerEventHandlerTest {
    ...
    fun createLedgerEventHandler() {
        ...
        assertThat(ledgerEventHandler.description()).contains("My Description")
        assertThat(ledgerEventHandler.discardedAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(ledgerEventHandler.ledgerId()).contains("ledger_id")
        ...
        assertThat(ledgerEventHandler.metadata())
            .contains(LedgerEventHandler.Metadata.builder().build())
        ...
        assertThat(ledgerEventHandler.variables())
            .contains(LedgerEventHandler.LedgerEventHandlerVariables.builder().build())
    }
}
