...
internal class LedgerTransactionCreateReversalParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.ledgerableType()).contains(LedgerTransactionCreateReversalParams.LedgerableType.EXPECTED_PAYMENT)
      assertThat(body.metadata()).contains(LedgerTransactionCreateReversalParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
