...
internal class PaymentFlowTest {
    ...
    fun create() {
      ...
      assertThat(paymentFlow.createdAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(paymentFlow.existingExternalAccountsFilter()).contains(PaymentFlow.ExistingExternalAccountsFilter.VERIFIED)
      assertThat(paymentFlow.externalAccountCollection()).contains(PaymentFlow.ExternalAccountCollection.DISABLED)
      assertThat(paymentFlow.liveMode()).contains(true)
      assertThat(paymentFlow.object_()).contains("object")
      assertThat(paymentFlow.originatingAccountId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(paymentFlow.paymentOrderId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(paymentFlow.receivingAccountId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(paymentFlow.updatedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
