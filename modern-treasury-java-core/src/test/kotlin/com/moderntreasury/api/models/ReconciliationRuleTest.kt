...
internal class ReconciliationRuleTest {
    ...
    fun create() {
      ...
      assertThat(reconciliationRule.counterpartyId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(reconciliationRule.currency()).contains(Currency.AED)
      assertThat(reconciliationRule.customIdentifiers()).contains(ReconciliationRule.CustomIdentifiers.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
