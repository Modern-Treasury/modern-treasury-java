...
internal class LegalEntityAssociationInlineCreateTest {
    ...
    fun create() {
      ...
      assertThat(legalEntityAssociationInlineCreate.childLegalEntity()).contains(ChildLegalEntityCreate.builder()
          .addAddress(LegalEntityAddressCreateRequest.builder()
              .country("country")
              .line1("line1")
              .locality("locality")
          ...
          .website("website")
          .build())
      assertThat(legalEntityAssociationInlineCreate.childLegalEntityId()).contains("child_legal_entity_id")
      assertThat(legalEntityAssociationInlineCreate.ownershipPercentage()).contains(0L)
      assertThat(legalEntityAssociationInlineCreate.title()).contains("title")
    }
