...
internal class LedgerTransactionUpdateTest {
    ...
    fun create() {
        ...
        assertThat(ledgerTransactionUpdate.description()).contains("description")
        assertThat(ledgerTransactionUpdate.effectiveAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(ledgerTransactionUpdate.ledgerEntries().getOrNull())
            .containsExactly(
                LedgerEntryCreateRequest.builder()
                    .amount(0L)
                    .direction(TransactionDirection.CREDIT)
        ...
        assertThat(ledgerTransactionUpdate.ledgerableType())
            .contains(LedgerTransactionUpdate.LedgerableType.EXPECTED_PAYMENT)
        ...
        assertThat(ledgerTransactionUpdate.status())
            .contains(LedgerTransactionUpdate.Status.ARCHIVED)
    }
