...
internal class InternalAccountTest {
    ...
    fun create() {
      ...
      assertThat(internalAccount.accountDetails()).containsExactly(AccountDetail.builder()
          ...
          .accountNumber("account_number")
          .build())
      assertThat(internalAccount.accountType()).contains(InternalAccount.AccountType.BASE_WALLET)
      assertThat(internalAccount.connection()).isEqualTo(Connection.builder()
          ...
          .vendorName("vendor_name")
          .build())
      assertThat(internalAccount.contraLedgerAccountId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(internalAccount.counterpartyId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(internalAccount.debitable()).contains(true)
      assertThat(internalAccount.externalId()).contains("external_id")
      assertThat(internalAccount.ledgerAccountId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(internalAccount.parentAccountId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(internalAccount.partyAddress()).contains(Address.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .country("country")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .line1("line1")
