...
internal class ChildLegalEntityCreateTest {
    ...
    fun create() {
        ...
        assertThat(childLegalEntityCreate.countryOfIncorporation()).contains("US")
        ...
        assertThat(childLegalEntityCreate.operatingJurisdictions().getOrNull())
        ...
        assertThat(childLegalEntityCreate.primarySocialMediaSites().getOrNull())
            .containsExactly("string")
        assertThat(childLegalEntityCreate.regulators().getOrNull())
            .containsExactly(
                ChildLegalEntityCreate.LegalEntityRegulator.builder()
                    .jurisdiction("jurisdiction")
                    .name("name")
        ...
        assertThat(childLegalEntityCreate.thirdPartyVerifications().getOrNull())
            .containsExactly(
                ThirdPartyVerification.builder()
                    .outcome(ThirdPartyVerification.Outcome.PASSED)
                    .vendor(ThirdPartyVerification.Vendor.PERSONA)
