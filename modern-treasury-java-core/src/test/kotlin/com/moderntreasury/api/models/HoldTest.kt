...
internal class HoldTest {
    ...
    fun create() {
        ...
        assertThat(hold.liveMode()).contains(true)
        ...
        assertThat(hold.reason()).contains("reason")
        assertThat(hold.resolution()).contains("resolution")
        assertThat(hold.resolvedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
