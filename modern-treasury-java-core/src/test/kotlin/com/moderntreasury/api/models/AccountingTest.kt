...
internal class AccountingTest {
    ...
    fun create() {
        ...
        assertThat(accounting.accountId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(accounting.classId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    }
