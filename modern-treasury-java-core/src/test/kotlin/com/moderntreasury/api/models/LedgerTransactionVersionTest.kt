...
internal class LedgerTransactionVersionTest {
    ...
    fun create() {
        ...
        assertThat(ledgerTransactionVersion.archivedReason()).contains("archived_reason")
        assertThat(ledgerTransactionVersion.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(ledgerTransactionVersion.description()).contains("description")
        ...
        assertThat(ledgerTransactionVersion.externalId()).contains("external_id")
        ...
        assertThat(ledgerTransactionVersion.ledgerableType())
            .contains(LedgerTransactionVersion.LedgerableType.EXPECTED_PAYMENT)
