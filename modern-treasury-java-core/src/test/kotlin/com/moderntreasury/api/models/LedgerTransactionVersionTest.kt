...
class LedgerTransactionVersionTest {
    ...
    fun createLedgerTransactionVersion() {
        ...
        assertThat(ledgerTransactionVersion.description()).contains("string")
        ...
        assertThat(ledgerTransactionVersion.externalId()).contains("string")
        ...
        assertThat(ledgerTransactionVersion.reversedByLedgerTransactionId()).contains("string")
        assertThat(ledgerTransactionVersion.reversesLedgerTransactionId()).contains("string")
