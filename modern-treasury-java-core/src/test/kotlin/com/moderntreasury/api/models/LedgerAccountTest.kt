...
internal class LedgerAccountTest {
    ...
    fun create() {
      ...
      assertThat(ledgerAccount.discardedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(ledgerAccount.ledgerableType()).contains(LedgerAccount.LedgerableType.COUNTERPARTY)
