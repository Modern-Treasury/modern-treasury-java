...
internal class TransactionTest {
    ...
    fun create() {
      ...
      assertThat(transaction.discardedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(transaction.foreignExchangeRate()).contains(ForeignExchangeRate.builder()
          .baseAmount(0L)
          .baseCurrency(Currency.AED)
          .exponent(0L)
          .rateString("rate_string")
      ...
      assertThat(transaction.details()).contains(Transaction.Details.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
