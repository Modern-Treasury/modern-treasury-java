...
internal class LegalEntityUpdateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.legalStructure()).contains(LegalEntityUpdateParams.LegalStructure.CORPORATION)
      assertThat(body.listedExchange()).contains("listed_exchange")
      assertThat(body.metadata()).contains(LegalEntityUpdateParams.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(body.phoneNumbers().getOrNull()).containsExactly(LegalEntityUpdateParams.PhoneNumber.builder()
          .phoneNumber("phone_number")
          .build())
      ...
      assertThat(body.regulators().getOrNull()).containsExactly(LegalEntityUpdateParams.LegalEntityRegulator.builder()
          .jurisdiction("jurisdiction")
          .name("name")
          .registrationNumber("registration_number")
          .build())
      ...
      assertThat(body.termsOfUse()).contains(LegalEntityUpdateParams.TermsOfUse.builder()
          .acceptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .ipAddress("ip_address")
          .build())
