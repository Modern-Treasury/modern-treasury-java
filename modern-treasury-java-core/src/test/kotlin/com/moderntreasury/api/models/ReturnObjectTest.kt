...
internal class ReturnObjectTest {
    ...
    fun create() {
      ...
      assertThat(returnObject.corrections()).contains(ReturnObject.Corrections.builder()
          .accountNumber("account_number")
          .companyId("company_id")
          .companyName("company_name")
          .individualIdentificationNumber("individual_identification_number")
      ...
      assertThat(returnObject.discardedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(returnObject.failureReason()).contains("failure_reason")
      assertThat(returnObject.internalAccountId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(returnObject.ledgerTransactionId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(returnObject.returnableType()).contains(ReturnObject.ReturnableType.INCOMING_PAYMENT_DETAIL)
      ...
      assertThat(returnObject.transactionLineItemId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
