...
internal class ContactDetailCreateRequestTest {
    ...
    fun create() {
      ...
      assertThat(contactDetailCreateRequest.contactIdentifier()).contains("contact_identifier")
      assertThat(contactDetailCreateRequest.contactIdentifierType()).contains(ContactDetailCreateRequest.ContactIdentifierType.EMAIL)
    }
