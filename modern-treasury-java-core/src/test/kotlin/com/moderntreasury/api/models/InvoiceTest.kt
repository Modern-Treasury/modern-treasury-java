...
class InvoiceTest {
    ...
    fun createInvoice() {
        ...
        assertThat(invoice.fallbackPaymentMethod()).contains("string")
        ...
        assertThat(invoice.recipientEmail()).contains("string")
        assertThat(invoice.recipientName()).contains("string")
        assertThat(invoice.remindAfterOverdueDays().get()).containsExactly(123L)
