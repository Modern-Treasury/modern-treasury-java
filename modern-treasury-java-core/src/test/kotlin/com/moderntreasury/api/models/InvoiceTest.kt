...
internal class InvoiceTest {
    ...
    fun create() {
      ...
      assertThat(invoice.contactDetails()).containsExactly(ContactDetail.builder()
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(invoice.counterpartyBillingAddress()).contains(Invoice.CounterpartyBillingAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
      ...
      assertThat(invoice.counterpartyShippingAddress()).contains(Invoice.CounterpartyShippingAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
      ...
      assertThat(invoice.expectedPayments()).containsExactly(ExpectedPayment.builder()
          ...
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(invoice.fallbackPaymentMethod()).contains("fallback_payment_method")
      assertThat(invoice.hostedUrl()).isEqualTo("hosted_url")
      assertThat(invoice.invoicerAddress()).contains(Invoice.InvoicerAddress.builder()
          .country("country")
          .line1("line1")
          .locality("locality")
          .postalCode("postal_code")
          ...
          .line2("line2")
          .build())
      assertThat(invoice.invoicerName()).contains("invoicer_name")
      assertThat(invoice.issuedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(invoice.ledgerAccountSettlementId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(invoice.liveMode()).isEqualTo(true)
      assertThat(invoice.metadata()).contains(Invoice.Metadata.builder()
          .putAdditionalProperty("key", JsonValue.from("value"))
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .putAdditionalProperty("modern", JsonValue.from("treasury"))
          .build())
      ...
      assertThat(invoice.pdfUrl()).contains("pdf_url")
      ...
      assertThat(invoice.virtualAccountId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
