...
internal class ReturnCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.corrections()).contains(ReturnCreateParams.Corrections.builder()
          .accountNumber("account_number")
          .companyId("company_id")
          .companyName("company_name")
          .individualIdentificationNumber("individual_identification_number")
      ...
      assertThat(body.reconciliationStatus()).contains(ReturnCreateParams.ReconciliationStatus.UNRECONCILED)
    }
