...
internal class CounterpartyServiceAsyncTest {
    ...
    fun create() {
        ...
        val counterparty = counterpartyFuture.get()
    ...
    fun retrieve() {
        ...
        val counterpartyFuture = counterpartyServiceAsync.retrieve("id")
    ...
    fun list() {
        ...
        val pageFuture = counterpartyServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = counterpartyServiceAsync.delete("id")
    ...
    fun collectAccount() {
        ...
        val counterpartyCollectAccountResponseFuture =
        ...
        val counterpartyCollectAccountResponse = counterpartyCollectAccountResponseFuture.get()
