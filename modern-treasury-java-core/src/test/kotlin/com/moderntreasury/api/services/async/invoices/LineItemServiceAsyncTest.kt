...
internal class LineItemServiceAsyncTest {
    ...
    fun create() {
      ...
      val invoiceLineItemFuture = lineItemServiceAsync.create(InvoiceLineItemCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val invoiceLineItemFuture = lineItemServiceAsync.retrieve(InvoiceLineItemRetrieveParams.builder()
          .invoiceId("invoice_id")
          .id("id")
          .build())
    ...
    fun update() {
      ...
      val invoiceLineItemFuture = lineItemServiceAsync.update(InvoiceLineItemUpdateParams.builder()
          .invoiceId("invoice_id")
          .id("id")
          .description("description")
          .direction("direction")
    ...
    fun delete() {
      ...
      val invoiceLineItemFuture = lineItemServiceAsync.delete(InvoiceLineItemDeleteParams.builder()
          .invoiceId("invoice_id")
          .id("id")
          .build())
