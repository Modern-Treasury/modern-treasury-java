...
internal class LedgerAccountServiceAsyncTest {
    ...
    fun create() {
      ...
      val ledgerAccountFuture = ledgerAccountServiceAsync.create(LedgerAccountCreateRequest.builder()
          .currency("currency")
    ...
    fun retrieve() {
      ...
      val ledgerAccountFuture = ledgerAccountServiceAsync.retrieve(LedgerAccountRetrieveParams.builder()
          .id("id")
    ...
    fun update() {
      ...
      val ledgerAccountFuture = ledgerAccountServiceAsync.update(LedgerAccountUpdateParams.builder()
          .id("id")
          .description("description")
          .externalId("external_id")
