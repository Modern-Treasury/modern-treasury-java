...
internal class LegalEntityAssociationServiceAsyncTest {
    ...
    fun create() {
        ...
        val legalEntityAssociationFuture =
        ...
        val legalEntityAssociation = legalEntityAssociationFuture.get()
    ...
    fun delete() {
        ...
        val legalEntityAssociationFuture = legalEntityAssociationServiceAsync.delete("id")
