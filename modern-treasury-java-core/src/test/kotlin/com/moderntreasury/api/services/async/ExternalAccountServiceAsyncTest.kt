...
internal class ExternalAccountServiceAsyncTest {
    ...
    fun create() {
      ...
      val externalAccountFuture = externalAccountServiceAsync.create(ExternalAccountCreateParams.builder()
    ...
    fun update() {
      ...
      val externalAccountFuture = externalAccountServiceAsync.update(ExternalAccountUpdateParams.builder()
          .id("id")
          .accountType(ExternalAccountType.BASE_WALLET)
          .counterpartyId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun completeVerification() {
      ...
      val externalAccountFuture = externalAccountServiceAsync.completeVerification(ExternalAccountCompleteVerificationParams.builder()
          .id("id")
          .addAmount(2L)
          .addAmount(4L)
          .build())
    ...
    fun verify() {
      ...
      val responseFuture = externalAccountServiceAsync.verify(ExternalAccountVerifyParams.builder()
          .id("id")
