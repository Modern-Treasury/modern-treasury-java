...
internal class BalanceReportServiceAsyncTest {
    ...
    fun create() {
      ...
      val balanceReportFuture = balanceReportServiceAsync.create(BalanceReportCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val balanceReportFuture = balanceReportServiceAsync.retrieve(BalanceReportRetrieveParams.builder()
          .internalAccountId("internal_account_id")
    ...
    fun delete() {
      ...
      val future = balanceReportServiceAsync.delete(BalanceReportDeleteParams.builder()
          .internalAccountId("internal_account_id")
          .id("id")
          .build())
