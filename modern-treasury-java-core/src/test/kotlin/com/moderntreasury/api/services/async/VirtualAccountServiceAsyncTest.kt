...
internal class VirtualAccountServiceAsyncTest {
    ...
    fun create() {
      ...
      val virtualAccountFuture = virtualAccountServiceAsync.create(VirtualAccountCreateParams.builder()
    ...
    fun update() {
      ...
      val virtualAccountFuture = virtualAccountServiceAsync.update(VirtualAccountUpdateParams.builder()
          .id("id")
          .counterpartyId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
