...
internal class AccountCollectionFlowServiceAsyncTest {
    ...
    fun create() {
      ...
      val accountCollectionFlowFuture = accountCollectionFlowServiceAsync.create(AccountCollectionFlowCreateParams.builder()
    ...
    fun update() {
      ...
      val accountCollectionFlowFuture = accountCollectionFlowServiceAsync.update(AccountCollectionFlowUpdateParams.builder()
          .id("id")
