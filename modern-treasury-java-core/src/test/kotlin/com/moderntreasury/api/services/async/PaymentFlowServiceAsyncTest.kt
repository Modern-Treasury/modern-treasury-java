...
internal class PaymentFlowServiceAsyncTest {
    ...
    fun create() {
      ...
      val paymentFlowFuture = paymentFlowServiceAsync.create(PaymentFlowCreateParams.builder()
          .amount(0L)
    ...
    fun update() {
      ...
      val paymentFlowFuture = paymentFlowServiceAsync.update(PaymentFlowUpdateParams.builder()
          .id("id")
