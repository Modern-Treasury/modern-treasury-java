...
internal class PaymentActionServiceAsyncTest {
    ...
    fun create() {
      ...
      val paymentActionFuture = paymentActionServiceAsync.create(PaymentActionCreateParams.builder()
          .type("type")
    ...
    fun update() {
      ...
      val paymentActionFuture = paymentActionServiceAsync.update(PaymentActionUpdateParams.builder()
          .id("id")
