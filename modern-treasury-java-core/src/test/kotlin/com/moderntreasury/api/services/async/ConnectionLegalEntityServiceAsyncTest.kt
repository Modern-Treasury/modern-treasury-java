...
internal class ConnectionLegalEntityServiceAsyncTest {
    ...
    fun create() {
        ...
        val connectionLegalEntityFuture =
        ...
        val connectionLegalEntity = connectionLegalEntityFuture.get()
    ...
    fun retrieve() {
        ...
        val connectionLegalEntityFuture = connectionLegalEntityServiceAsync.retrieve("id")
    ...
    fun list() {
        ...
        val pageFuture = connectionLegalEntityServiceAsync.list()
