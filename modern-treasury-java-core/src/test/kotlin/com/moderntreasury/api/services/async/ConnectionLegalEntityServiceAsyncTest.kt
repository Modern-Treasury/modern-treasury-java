...
internal class ConnectionLegalEntityServiceAsyncTest {
    ...
    fun create() {
      ...
      val connectionLegalEntityFuture = connectionLegalEntityServiceAsync.create(ConnectionLegalEntityCreateParams.builder()
    ...
    fun update() {
      ...
      val connectionLegalEntityFuture = connectionLegalEntityServiceAsync.update(ConnectionLegalEntityUpdateParams.builder()
          .id("id")
