...
internal class LedgerServiceAsyncTest {
    ...
    fun create() {
      ...
      val ledgerFuture = ledgerServiceAsync.create(LedgerCreateParams.builder()
          .name("name")
    ...
    fun retrieve() {
      ...
      val ledgerFuture = ledgerServiceAsync.retrieve("id")
    ...
    fun update() {
      ...
      val ledgerFuture = ledgerServiceAsync.update(LedgerUpdateParams.builder()
          .id("id")
          .description("description")
    ...
    fun delete() {
      ...
      val ledgerFuture = ledgerServiceAsync.delete("id")
