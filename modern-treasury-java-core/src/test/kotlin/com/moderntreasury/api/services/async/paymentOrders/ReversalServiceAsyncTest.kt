...
internal class ReversalServiceAsyncTest {
    ...
    fun create() {
      ...
      val reversalFuture = reversalServiceAsync.create(PaymentOrderReversalCreateParams.builder()
      ...
      val reversal = reversalFuture.get()
      reversal.validate()
    }
    ...
    fun retrieve() {
      ...
      val reversalFuture = reversalServiceAsync.retrieve(PaymentOrderReversalRetrieveParams.builder()
          .paymentOrderId("payment_order_id")
    ...
    fun list() {
      ...
      val pageFuture = reversalServiceAsync.list("payment_order_id")
