...
internal class LedgerAccountCategoryServiceAsyncTest {
    ...
    fun create() {
      ...
      val ledgerAccountCategoryFuture = ledgerAccountCategoryServiceAsync.create(LedgerAccountCategoryCreateParams.builder()
          .currency("currency")
    ...
    fun retrieve() {
      ...
      val ledgerAccountCategoryFuture = ledgerAccountCategoryServiceAsync.retrieve(LedgerAccountCategoryRetrieveParams.builder()
          .id("id")
    ...
    fun update() {
      ...
      val ledgerAccountCategoryFuture = ledgerAccountCategoryServiceAsync.update(LedgerAccountCategoryUpdateParams.builder()
          .id("id")
          .description("description")
          .externalId("external_id")
    ...
    fun addLedgerAccount() {
      ...
      val future = ledgerAccountCategoryServiceAsync.addLedgerAccount(LedgerAccountCategoryAddLedgerAccountParams.builder()
          .id("id")
    ...
    fun addNestedCategory() {
      ...
      val future = ledgerAccountCategoryServiceAsync.addNestedCategory(LedgerAccountCategoryAddNestedCategoryParams.builder()
          .id("id")
    ...
    fun removeLedgerAccount() {
      ...
      val future = ledgerAccountCategoryServiceAsync.removeLedgerAccount(LedgerAccountCategoryRemoveLedgerAccountParams.builder()
          .id("id")
          .ledgerAccountId("ledger_account_id")
          .build())
    ...
    fun removeNestedCategory() {
      ...
      val future = ledgerAccountCategoryServiceAsync.removeNestedCategory(LedgerAccountCategoryRemoveNestedCategoryParams.builder()
          .id("id")
          .subCategoryId("sub_category_id")
          .build())
