...
internal class LedgerEntryServiceAsyncTest {
    ...
    fun retrieve() {
      ...
      val ledgerEntryFuture = ledgerEntryServiceAsync.retrieve(LedgerEntryRetrieveParams.builder()
          .id("id")
          .showBalances(true)
          .build())
    ...
    fun update() {
      ...
      val ledgerEntryFuture = ledgerEntryServiceAsync.update(LedgerEntryUpdateParams.builder()
          .id("id")
