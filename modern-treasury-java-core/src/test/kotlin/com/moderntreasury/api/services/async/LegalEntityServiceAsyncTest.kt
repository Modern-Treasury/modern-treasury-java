...
internal class LegalEntityServiceAsyncTest {
    ...
    fun create() {
      ...
      val legalEntityFuture = legalEntityServiceAsync.create(LegalEntityCreateParams.builder()
    ...
    fun update() {
      ...
      val legalEntityFuture = legalEntityServiceAsync.update(LegalEntityUpdateParams.builder()
          .id("id")
          .addAddress(LegalEntityAddressCreateRequest.builder()
              .country("country")
              .line1("line1")
