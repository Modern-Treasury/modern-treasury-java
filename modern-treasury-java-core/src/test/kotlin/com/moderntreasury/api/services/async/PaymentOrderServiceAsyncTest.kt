...
internal class PaymentOrderServiceAsyncTest {
    ...
    fun create() {
      ...
      val paymentOrderFuture = paymentOrderServiceAsync.create(PaymentOrderCreateParams.builder()
          .amount(0L)
    ...
    fun update() {
      ...
      val paymentOrderFuture = paymentOrderServiceAsync.update(PaymentOrderUpdateParams.builder()
          .id("id")
    ...
    fun createAsync() {
      ...
      val asyncResponseFuture = paymentOrderServiceAsync.createAsync(PaymentOrderCreateAsyncParams.builder()
          .amount(0L)
