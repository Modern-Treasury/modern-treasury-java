...
interface ModernTreasuryClient {
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): ModernTreasuryClient.WithRawResponse
        ...
        @MustBeClosed
        fun ping(): HttpResponseFor<PingResponse> = ping(ClientPingParams.none())
        ...
        /** @see ping */
        @MustBeClosed
        fun ping(params: ClientPingParams = ClientPingParams.none()): HttpResponseFor<PingResponse> =
            ping(
              params, RequestOptions.none()
            )
