...
class ModernTreasuryClientImpl(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ModernTreasuryClient = ModernTreasuryClientImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ModernTreasuryClient.WithRawResponse = ModernTreasuryClientImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
