...
class PaymentActionServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PaymentActionServiceAsync = PaymentActionServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: PaymentActionCreateParams, requestOptions: RequestOptions): CompletableFuture<PaymentActionCreateResponse> =
        // post /api/payment_actions
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: PaymentActionRetrieveParams, requestOptions: RequestOptions): CompletableFuture<PaymentActionRetrieveResponse> =
        // get /api/payment_actions/{id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: PaymentActionUpdateParams, requestOptions: RequestOptions): CompletableFuture<PaymentActionUpdateResponse> =
        // patch /api/payment_actions/{id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: PaymentActionListParams, requestOptions: RequestOptions): CompletableFuture<PaymentActionListPageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PaymentActionServiceAsync.WithRawResponse = PaymentActionServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: PaymentActionCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PaymentActionCreateResponse>> {
        ...
        override fun retrieve(params: PaymentActionRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PaymentActionRetrieveResponse>> {
        ...
        override fun update(params: PaymentActionUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PaymentActionUpdateResponse>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun list(params: PaymentActionListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PaymentActionListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "payment_actions")
