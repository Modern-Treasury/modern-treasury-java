...
interface ConnectionService {
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): ConnectionService.WithRawResponse
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: ConnectionListParams = ConnectionListParams.none()): HttpResponseFor<ConnectionListPage> =
            list(
              params, RequestOptions.none()
            )
