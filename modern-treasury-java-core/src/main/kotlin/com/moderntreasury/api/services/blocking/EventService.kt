...
interface EventService {
    ...
    interface WithRawResponse {
        ...
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<Event> =
            retrieve(
              id, EventRetrieveParams.none()
            )
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: String, params: EventRetrieveParams = EventRetrieveParams.none()): HttpResponseFor<Event> =
            retrieve(
              id,
              params,
              RequestOptions.none(),
        ...
        @MustBeClosed
        fun list(): HttpResponseFor<EventListPage> = list(EventListParams.none())
