...
class LedgerAccountBalanceMonitorServiceImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LedgerAccountBalanceMonitorService = LedgerAccountBalanceMonitorServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LedgerAccountBalanceMonitorService.WithRawResponse = LedgerAccountBalanceMonitorServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
