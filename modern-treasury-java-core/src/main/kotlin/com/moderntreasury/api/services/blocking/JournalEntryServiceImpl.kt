...
class JournalEntryServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): JournalEntryService =
        JournalEntryServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
