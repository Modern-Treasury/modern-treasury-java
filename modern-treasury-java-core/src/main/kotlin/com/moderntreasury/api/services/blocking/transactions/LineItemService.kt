...
interface LineItemService {
    ...
    /** @see retrieve */
    fun retrieve(id: String, params: TransactionLineItemRetrieveParams = TransactionLineItemRetrieveParams.none()): TransactionLineItem =
        retrieve(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see list */
    fun list(params: TransactionLineItemListParams = TransactionLineItemListParams.none()): TransactionLineItemListPage =
        list(
          params, RequestOptions.none()
        )
    ...
    /** @see delete */
    fun delete(id: String, params: TransactionLineItemDeleteParams = TransactionLineItemDeleteParams.none()) =
        delete(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see delete */
    fun delete(params: TransactionLineItemDeleteParams) =
        delete(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: String, params: TransactionLineItemRetrieveParams = TransactionLineItemRetrieveParams.none()): HttpResponseFor<TransactionLineItem> =
            retrieve(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: TransactionLineItemRetrieveParams): HttpResponseFor<TransactionLineItem> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        @MustBeClosed
        fun list(): HttpResponseFor<TransactionLineItemListPage> = list(TransactionLineItemListParams.none())
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: TransactionLineItemListParams = TransactionLineItemListParams.none()): HttpResponseFor<TransactionLineItemListPage> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(id: String, params: TransactionLineItemDeleteParams = TransactionLineItemDeleteParams.none()): HttpResponse =
            delete(
              id,
              params,
              RequestOptions.none(),
