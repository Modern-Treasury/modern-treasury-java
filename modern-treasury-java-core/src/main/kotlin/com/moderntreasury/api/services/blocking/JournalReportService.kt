...
interface JournalReportService {
    ...
    fun retrieve(id: String) = retrieve(id, JournalReportRetrieveParams.none())
    ...
    /** @see retrieve */
    fun retrieve(params: JournalReportRetrieveParams) = retrieve(params, RequestOptions.none())
    ...
    fun update(id: String) = update(id, JournalReportUpdateParams.none())
    ...
    /** @see update */
    fun update(params: JournalReportUpdateParams) = update(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponse = retrieve(id, JournalReportRetrieveParams.none())
         ...
         */
        @MustBeClosed
        fun update(id: String): HttpResponse = update(id, JournalReportUpdateParams.none())
         ...
         */
        @MustBeClosed fun list(): HttpResponse = list(JournalReportListParams.none())
