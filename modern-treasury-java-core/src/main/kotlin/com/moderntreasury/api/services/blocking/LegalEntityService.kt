...
interface LegalEntityService {
    ...
    fun updateStatus(id: String, params: LegalEntityUpdateStatusParams): LegalEntity =
    ...
    /** @see updateStatus */
    fun updateStatus(params: LegalEntityUpdateStatusParams): LegalEntity =
    ...
    interface WithRawResponse {
        ...
        fun updateStatus(
            id: String,
            params: LegalEntityUpdateStatusParams,
        ): HttpResponseFor<LegalEntity> = updateStatus(id, params, RequestOptions.none())
        ...
        /** @see updateStatus */
        @MustBeClosed
        fun updateStatus(params: LegalEntityUpdateStatusParams): HttpResponseFor<LegalEntity> =
            updateStatus(params, RequestOptions.none())
