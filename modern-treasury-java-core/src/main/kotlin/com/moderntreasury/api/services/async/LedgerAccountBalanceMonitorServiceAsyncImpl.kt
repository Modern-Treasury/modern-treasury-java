...
class LedgerAccountBalanceMonitorServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LedgerAccountBalanceMonitorServiceAsync = LedgerAccountBalanceMonitorServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: LedgerAccountBalanceMonitorCreateParams, requestOptions: RequestOptions): CompletableFuture<LedgerAccountBalanceMonitor> =
        // post /api/ledger_account_balance_monitors
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: LedgerAccountBalanceMonitorRetrieveParams, requestOptions: RequestOptions): CompletableFuture<LedgerAccountBalanceMonitor> =
        // get /api/ledger_account_balance_monitors/{id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: LedgerAccountBalanceMonitorUpdateParams, requestOptions: RequestOptions): CompletableFuture<LedgerAccountBalanceMonitor> =
        // patch /api/ledger_account_balance_monitors/{id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: LedgerAccountBalanceMonitorListParams, requestOptions: RequestOptions): CompletableFuture<LedgerAccountBalanceMonitorListPageAsync> =
        // get /api/ledger_account_balance_monitors
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: LedgerAccountBalanceMonitorDeleteParams, requestOptions: RequestOptions): CompletableFuture<LedgerAccountBalanceMonitor> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LedgerAccountBalanceMonitorServiceAsync.WithRawResponse = LedgerAccountBalanceMonitorServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: LedgerAccountBalanceMonitorCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<LedgerAccountBalanceMonitor>> {
        ...
        override fun retrieve(params: LedgerAccountBalanceMonitorRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<LedgerAccountBalanceMonitor>> {
        ...
        override fun update(params: LedgerAccountBalanceMonitorUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<LedgerAccountBalanceMonitor>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun list(params: LedgerAccountBalanceMonitorListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<LedgerAccountBalanceMonitorListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "ledger_account_balance_monitors")
        ...
        override fun delete(params: LedgerAccountBalanceMonitorDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<LedgerAccountBalanceMonitor>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
