...
class BulkRequestServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BulkRequestServiceAsync = BulkRequestServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: BulkRequestCreateParams, requestOptions: RequestOptions): CompletableFuture<BulkRequest> =
        // post /api/bulk_requests
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: BulkRequestRetrieveParams, requestOptions: RequestOptions): CompletableFuture<BulkRequest> =
        // get /api/bulk_requests/{id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun list(params: BulkRequestListParams, requestOptions: RequestOptions): CompletableFuture<BulkRequestListPageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BulkRequestServiceAsync.WithRawResponse = BulkRequestServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<BulkRequest> = jsonHandler<BulkRequest>(clientOptions.jsonMapper)

        override fun create(params: BulkRequestCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BulkRequest>> {
        ...
        override fun retrieve(params: BulkRequestRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BulkRequest>> {
        ...
        override fun list(params: BulkRequestListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BulkRequestListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "bulk_requests")
