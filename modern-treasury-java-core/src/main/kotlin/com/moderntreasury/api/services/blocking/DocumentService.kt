...
interface DocumentService {
    ...
    /** Create a document. */
    fun create(params: DocumentCreateParams): Document =
        create(
    ...
    fun retrieve(id: String): Document =
        retrieve(
    ...
    /** @see retrieve */
    fun retrieve(id: String, params: DocumentRetrieveParams = DocumentRetrieveParams.none()): Document =
        retrieve(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see retrieve */
    fun retrieve(params: DocumentRetrieveParams): Document =
        retrieve(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: String, params: DocumentRetrieveParams = DocumentRetrieveParams.none()): HttpResponseFor<Document> =
            retrieve(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: DocumentListParams = DocumentListParams.none()): HttpResponseFor<DocumentListPage> =
            list(
              params, RequestOptions.none()
            )
