...
interface JournalSourceService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): JournalSourceService

    /** Retrieve a specific journal source */
    fun retrieve(id: String) = retrieve(id, JournalSourceRetrieveParams.none())
    ...
    /** @see retrieve */
    fun retrieve(params: JournalSourceRetrieveParams) = retrieve(params, RequestOptions.none())
    ...
    fun list() = list(JournalSourceListParams.none())
    ...
    /** @see list */
    fun list(params: JournalSourceListParams = JournalSourceListParams.none()) =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponse = retrieve(id, JournalSourceRetrieveParams.none())
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: JournalSourceRetrieveParams): HttpResponse =
         ...
         */
        @MustBeClosed fun list(): HttpResponse = list(JournalSourceListParams.none())
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: JournalSourceListParams = JournalSourceListParams.none()): HttpResponse =
            list(params, RequestOptions.none())
