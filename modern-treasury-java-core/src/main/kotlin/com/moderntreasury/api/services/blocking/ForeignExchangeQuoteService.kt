...
interface ForeignExchangeQuoteService {
    ...
    /** @see retrieve */
    fun retrieve(id: String, params: ForeignExchangeQuoteRetrieveParams = ForeignExchangeQuoteRetrieveParams.none()): ForeignExchangeQuote =
        retrieve(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see list */
    fun list(params: ForeignExchangeQuoteListParams = ForeignExchangeQuoteListParams.none()): ForeignExchangeQuoteListPage =
        list(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): ForeignExchangeQuoteService.WithRawResponse
        ...
        @MustBeClosed
        fun create(params: ForeignExchangeQuoteCreateParams): HttpResponseFor<ForeignExchangeQuote> =
            create(
              params, RequestOptions.none()
            )
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: String, params: ForeignExchangeQuoteRetrieveParams = ForeignExchangeQuoteRetrieveParams.none()): HttpResponseFor<ForeignExchangeQuote> =
            retrieve(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: ForeignExchangeQuoteRetrieveParams): HttpResponseFor<ForeignExchangeQuote> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        @MustBeClosed
        fun list(): HttpResponseFor<ForeignExchangeQuoteListPage> = list(ForeignExchangeQuoteListParams.none())
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: ForeignExchangeQuoteListParams = ForeignExchangeQuoteListParams.none()): HttpResponseFor<ForeignExchangeQuoteListPage> =
            list(
              params, RequestOptions.none()
            )
