...
class LineItemServiceImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LineItemService = LineItemServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): LineItemService.WithRawResponse = LineItemServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
