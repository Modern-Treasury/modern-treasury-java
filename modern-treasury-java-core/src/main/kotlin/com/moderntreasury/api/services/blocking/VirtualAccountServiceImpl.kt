...
class VirtualAccountServiceImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): VirtualAccountService = VirtualAccountServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): VirtualAccountService.WithRawResponse = VirtualAccountServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
