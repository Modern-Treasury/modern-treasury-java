...
class LineItemServiceAsyncImpl internal constructor(
    ...
    override fun create(params: TransactionLineItemCreateParams, requestOptions: RequestOptions): CompletableFuture<TransactionLineItem> =
        // post /api/transaction_line_items
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: TransactionLineItemRetrieveParams, requestOptions: RequestOptions): CompletableFuture<TransactionLineItem> =
        // get /api/transaction_line_items/{id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun list(params: TransactionLineItemListParams, requestOptions: RequestOptions): CompletableFuture<TransactionLineItemListPageAsync> =
        // get /api/transaction_line_items
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: TransactionLineItemDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: TransactionLineItemCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<TransactionLineItem>> {
        ...
        override fun retrieve(params: TransactionLineItemRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<TransactionLineItem>> {
        ...
        override fun list(params: TransactionLineItemListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<TransactionLineItemListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "transaction_line_items")
        ...
        override fun delete(params: TransactionLineItemDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
