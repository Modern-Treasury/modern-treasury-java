...
class JournalReportServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): JournalReportService =
        JournalReportServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
