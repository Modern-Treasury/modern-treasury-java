...
class ExpectedPaymentServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ExpectedPaymentServiceAsync = ExpectedPaymentServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: ExpectedPaymentCreateParams, requestOptions: RequestOptions): CompletableFuture<ExpectedPayment> =
        // post /api/expected_payments
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: ExpectedPaymentRetrieveParams, requestOptions: RequestOptions): CompletableFuture<ExpectedPayment> =
        // get /api/expected_payments/{id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: ExpectedPaymentUpdateParams, requestOptions: RequestOptions): CompletableFuture<ExpectedPayment> =
        // patch /api/expected_payments/{id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: ExpectedPaymentListParams, requestOptions: RequestOptions): CompletableFuture<ExpectedPaymentListPageAsync> =
        // get /api/expected_payments
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: ExpectedPaymentDeleteParams, requestOptions: RequestOptions): CompletableFuture<ExpectedPayment> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ExpectedPaymentServiceAsync.WithRawResponse = ExpectedPaymentServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<ExpectedPayment> = jsonHandler<ExpectedPayment>(clientOptions.jsonMapper)

        override fun create(params: ExpectedPaymentCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ExpectedPayment>> {
        ...
        override fun retrieve(params: ExpectedPaymentRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ExpectedPayment>> {
        ...
        override fun update(params: ExpectedPaymentUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ExpectedPayment>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun list(params: ExpectedPaymentListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ExpectedPaymentListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("api", "expected_payments")
        ...
        override fun delete(params: ExpectedPaymentDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ExpectedPayment>> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("id", params.id().getOrNull())
          val request = HttpRequest.builder()
