...
internal constructor(
    ...
    override fun addLedgerAccount(
        ...
        return request
            .thenComposeAsync { clientOptions.httpClient.executeAsync(it, requestOptions) }
            .thenApply { response -> response.use { addLedgerAccountHandler.handle(it) } }
    }
    ...
    override fun addNestedCategory(
        ...
        return request
            .thenComposeAsync { clientOptions.httpClient.executeAsync(it, requestOptions) }
            .thenApply { response -> response.use { addNestedCategoryHandler.handle(it) } }
    }
    ...
    override fun removeLedgerAccount(
        ...
        return request
            .thenComposeAsync { clientOptions.httpClient.executeAsync(it, requestOptions) }
            .thenApply { response -> response.use { removeLedgerAccountHandler.handle(it) } }
    }
    ...
    override fun removeNestedCategory(
        ...
        return request
            .thenComposeAsync { clientOptions.httpClient.executeAsync(it, requestOptions) }
            .thenApply { response -> response.use { removeNestedCategoryHandler.handle(it) } }
    }
}
