...
class InvoiceServiceAsyncImpl internal constructor(
    ...
    override fun retrieve(params: InvoiceRetrieveParams, requestOptions: RequestOptions): CompletableFuture<Invoice> =
        // get /api/invoices/{id}
    ...
    override fun addPaymentOrder(params: InvoiceAddPaymentOrderParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: InvoiceRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Invoice>> {
        ...
        override fun addPaymentOrder(params: InvoiceAddPaymentOrderParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
