...
interface CaseService {
    ...
    fun retrieve(id: String): Case = retrieve(id, CaseRetrieveParams.none())
    ...
    /** @see retrieve */
    fun retrieve(id: String, params: CaseRetrieveParams = CaseRetrieveParams.none()): Case =
    ...
    /** @see retrieve */
    fun retrieve(params: CaseRetrieveParams): Case = retrieve(params, RequestOptions.none())
    ...
    /** Get a list of cases. */
    fun list(): CaseListPage = list(CaseListParams.none())
    ...
    /** @see list */
    fun list(params: CaseListParams = CaseListParams.none()): CaseListPage =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<Case> = retrieve(id, CaseRetrieveParams.none())
        ...
        fun retrieve(
            id: String,
            params: CaseRetrieveParams = CaseRetrieveParams.none(),
        ): HttpResponseFor<Case> = retrieve(id, params, RequestOptions.none())
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: CaseRetrieveParams): HttpResponseFor<Case> =
         ...
         * [CaseService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<CaseListPage> = list(CaseListParams.none())
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: CaseListParams = CaseListParams.none()): HttpResponseFor<CaseListPage> =
            list(params, RequestOptions.none())
