...
interface LedgerAccountService {
    ...
    fun retrieve(id: String): LedgerAccount =
        retrieve(
    ...
    /** @see retrieve */
    fun retrieve(id: String, params: LedgerAccountRetrieveParams = LedgerAccountRetrieveParams.none()): LedgerAccount =
        retrieve(
          id,
          params,
          RequestOptions.none(),
    ...
    fun update(id: String): LedgerAccount =
        update(
    ...
    /** @see update */
    fun update(id: String, params: LedgerAccountUpdateParams = LedgerAccountUpdateParams.none()): LedgerAccount =
        update(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see list */
    fun list(params: LedgerAccountListParams = LedgerAccountListParams.none()): LedgerAccountListPage =
        list(
          params, RequestOptions.none()
        )
    ...
    fun delete(id: String): LedgerAccount =
        delete(
    ...
    /** @see delete */
    fun delete(id: String, params: LedgerAccountDeleteParams = LedgerAccountDeleteParams.none()): LedgerAccount =
        delete(
          id,
          params,
          RequestOptions.none(),
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): LedgerAccountService.WithRawResponse
        ...
        /** @see create */
        @MustBeClosed
        fun create(ledgerAccountCreateRequest: LedgerAccountCreateRequest): HttpResponseFor<LedgerAccount> =
            create(
              ledgerAccountCreateRequest, RequestOptions.none()
            )
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: String, params: LedgerAccountRetrieveParams = LedgerAccountRetrieveParams.none()): HttpResponseFor<LedgerAccount> =
            retrieve(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see update */
        @MustBeClosed
        fun update(id: String, params: LedgerAccountUpdateParams = LedgerAccountUpdateParams.none()): HttpResponseFor<LedgerAccount> =
            update(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: LedgerAccountListParams = LedgerAccountListParams.none()): HttpResponseFor<LedgerAccountListPage> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(id: String, params: LedgerAccountDeleteParams = LedgerAccountDeleteParams.none()): HttpResponseFor<LedgerAccount> =
            delete(
              id,
              params,
              RequestOptions.none(),
