...
interface PaymentActionService {
    ...
    fun retrieve(id: String): PaymentActionRetrieveResponse =
        retrieve(
    ...
    /** @see retrieve */
    fun retrieve(id: String, params: PaymentActionRetrieveParams = PaymentActionRetrieveParams.none()): PaymentActionRetrieveResponse =
        retrieve(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see retrieve */
    fun retrieve(params: PaymentActionRetrieveParams): PaymentActionRetrieveResponse =
        retrieve(
          params, RequestOptions.none()
        )
    ...
    fun update(id: String, params: PaymentActionUpdateParams): PaymentActionUpdateResponse =
        update(
          id,
          params,
          RequestOptions.none(),
    ...
    /** @see update */
    fun update(params: PaymentActionUpdateParams): PaymentActionUpdateResponse =
        update(
          params, RequestOptions.none()
        )
    ...
    /** @see list */
    fun list(params: PaymentActionListParams = PaymentActionListParams.none()): PaymentActionListPage =
        list(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): PaymentActionService.WithRawResponse

        /** Returns a raw HTTP response for `post /api/payment_actions`, but is otherwise the             same as [PaymentActionService.create]. */
        @MustBeClosed
        fun create(params: PaymentActionCreateParams): HttpResponseFor<PaymentActionCreateResponse> =
            create(
              params, RequestOptions.none()
            )
        ...
        @MustBeClosed
        fun retrieve(id: String): HttpResponseFor<PaymentActionRetrieveResponse> =
            retrieve(
              id, PaymentActionRetrieveParams.none()
            )
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: String, params: PaymentActionRetrieveParams = PaymentActionRetrieveParams.none()): HttpResponseFor<PaymentActionRetrieveResponse> =
            retrieve(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: PaymentActionRetrieveParams): HttpResponseFor<PaymentActionRetrieveResponse> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        @MustBeClosed
        fun update(id: String, params: PaymentActionUpdateParams): HttpResponseFor<PaymentActionUpdateResponse> =
            update(
              id,
              params,
              RequestOptions.none(),
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: PaymentActionUpdateParams): HttpResponseFor<PaymentActionUpdateResponse> =
            update(
              params, RequestOptions.none()
            )
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: PaymentActionListParams = PaymentActionListParams.none()): HttpResponseFor<PaymentActionListPage> =
            list(
              params, RequestOptions.none()
            )
