...
class ConnectionServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ConnectionServiceAsync = ConnectionServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun list(params: ConnectionListParams, requestOptions: RequestOptions): CompletableFuture<ConnectionListPageAsync> =
        // get /api/connections
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ConnectionServiceAsync.WithRawResponse = ConnectionServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val listHandler: Handler<List<Connection>> = jsonHandler<List<Connection>>(clientOptions.jsonMapper)

        override fun list(params: ConnectionListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ConnectionListPageAsync>> {
