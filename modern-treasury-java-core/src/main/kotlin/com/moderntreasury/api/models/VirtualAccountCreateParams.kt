...
private constructor(
     ...
     */
    fun accountDetails(): Optional<List<AccountDetailCreate>> = body.accountDetails()
     ...
     *   the server responded with an unexpected value).
     */
    fun routingDetails(): Optional<List<RoutingDetailCreate>> = body.routingDetails()
    ...
    private constructor(
         ...
         */
        fun accountDetails(): Optional<List<AccountDetailCreate>> =
         ...
         *   if the server responded with an unexpected value).
         */
        fun routingDetails(): Optional<List<RoutingDetailCreate>> =
