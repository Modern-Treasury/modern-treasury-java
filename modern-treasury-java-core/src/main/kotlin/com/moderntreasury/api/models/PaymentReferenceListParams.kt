...
class PaymentReferenceListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun referenceableId(referenceableId: Optional<String>) = referenceableId(referenceableId.getOrNull())
        ...
        fun referenceableType(referenceableType: Optional<ReferenceableType>) = referenceableType(referenceableType.getOrNull())
