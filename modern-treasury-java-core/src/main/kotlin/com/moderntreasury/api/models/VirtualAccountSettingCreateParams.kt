...
private constructor(
     ...
     */
    fun allocationIdentifier(): Optional<String> = body.allocationIdentifier()
     ...
     *   the server responded with an unexpected value).
     */
    fun allocationLength(): Optional<Long> = body.allocationLength()
     ...
     *   the server responded with an unexpected value).
     */
    fun allocationRangeEnd(): Optional<String> = body.allocationRangeEnd()
     ...
     *   the server responded with an unexpected value).
     */
    fun allocationRangeStart(): Optional<String> = body.allocationRangeStart()
     ...
     *   the server responded with an unexpected value).
     */
    fun generatedAllocationIdentifierLength(): Optional<Long> =
        body.generatedAllocationIdentifierLength()
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.allocationIdentifier] with
         * `allocationIdentifier.orElse(null)`.
         */
        fun allocationIdentifier(allocationIdentifier: Optional<String>) =
            allocationIdentifier(allocationIdentifier.getOrNull())
        ...
        /** Alias for calling [Builder.allocationLength] with `allocationLength.orElse(null)`. */
        fun allocationLength(allocationLength: Optional<Long>) =
            allocationLength(allocationLength.getOrNull())
        ...
        /**
         * Alias for calling [Builder.allocationRangeEnd] with `allocationRangeEnd.orElse(null)`.
         */
        fun allocationRangeEnd(allocationRangeEnd: Optional<String>) =
            allocationRangeEnd(allocationRangeEnd.getOrNull())
        ...
        /**
         * Alias for calling [Builder.allocationRangeStart] with
         * `allocationRangeStart.orElse(null)`.
         */
        fun allocationRangeStart(allocationRangeStart: Optional<String>) =
            allocationRangeStart(allocationRangeStart.getOrNull())
        ...
        /**
         * Alias for calling [Builder.generatedAllocationIdentifierLength] with
         * `generatedAllocationIdentifierLength.orElse(null)`.
         */
        fun generatedAllocationIdentifierLength(
            generatedAllocationIdentifierLength: Optional<Long>
        ) = generatedAllocationIdentifierLength(generatedAllocationIdentifierLength.getOrNull())
    ...
    private constructor(
         ...
         */
        fun allocationIdentifier(): Optional<String> =
            allocationIdentifier.getOptional("allocation_identifier")
         ...
         *   if the server responded with an unexpected value).
         */
        fun allocationLength(): Optional<Long> = allocationLength.getOptional("allocation_length")
         ...
         *   if the server responded with an unexpected value).
         */
        fun allocationRangeEnd(): Optional<String> =
            allocationRangeEnd.getOptional("allocation_range_end")
         ...
         *   if the server responded with an unexpected value).
         */
        fun allocationRangeStart(): Optional<String> =
            allocationRangeStart.getOptional("allocation_range_start")
         ...
         */
        fun generatedAllocationIdentifierLength(): Optional<Long> =
            generatedAllocationIdentifierLength.getOptional(
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [Builder.allocationRangeEnd] with
             * `allocationRangeEnd.orElse(null)`.
             */
            fun allocationRangeEnd(allocationRangeEnd: Optional<String>) =
                allocationRangeEnd(allocationRangeEnd.getOrNull())
        ...
        internal fun validity(): Int =
            (if (allocationType.asKnown().isPresent) 1 else 0) +
                (if (internalAccountId.asKnown().isPresent) 1 else 0) +
                (if (allocationIdentifier.asKnown().isPresent) 1 else 0) +
                (if (allocationLength.asKnown().isPresent) 1 else 0) +
                (if (allocationRangeEnd.asKnown().isPresent) 1 else 0) +
                (if (allocationRangeStart.asKnown().isPresent) 1 else 0) +
                (if (externalId.asKnown().isPresent) 1 else 0) +
                (if (generatedAllocationIdentifierLength.asKnown().isPresent) 1 else 0)
