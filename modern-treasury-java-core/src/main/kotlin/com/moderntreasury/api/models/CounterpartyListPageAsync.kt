...
class CounterpartyListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<CounterpartyListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<Counterparty> =
        AutoPagerAsync.from(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CounterpartyListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, headers, items)

    override fun toString() = "CounterpartyListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
