...
class LedgerTransactionVersion @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun partiallyPostsLedgerTransactionId(): Optional<String> = partiallyPostsLedgerTransactionId.getOptional("partially_posts_ledger_transaction_id")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun reversedByLedgerTransactionId(): Optional<String> = reversedByLedgerTransactionId.getOptional("reversed_by_ledger_transaction_id")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun reversesLedgerTransactionId(): Optional<String> = reversesLedgerTransactionId.getOptional("reverses_ledger_transaction_id")
    ...
    class Builder internal constructor() {
        ...
        fun archivedReason(archivedReason: Optional<String>) = archivedReason(archivedReason.getOrNull())
        ...
        /** Alias for calling [Builder.reversedByLedgerTransactionId] with `reversedByLedgerTransactionId.orElse(null)`. */
        fun reversedByLedgerTransactionId(reversedByLedgerTransactionId: Optional<String>) = reversedByLedgerTransactionId(reversedByLedgerTransactionId.getOrNull())
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (archivedReason.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (effectiveAt.asKnown().isPresent) 1 else 0) + (if (effectiveDate.asKnown().isPresent) 1 else 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (ledgerEntries.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (ledgerId.asKnown().isPresent) 1 else 0) + (if (ledgerTransactionId.asKnown().isPresent) 1 else 0) + (if (ledgerableId.asKnown().isPresent) 1 else 0) + (ledgerableType.asKnown().getOrNull()?.validity() ?: 0) + (if (liveMode.asKnown().isPresent) 1 else 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (if (object_.asKnown().isPresent) 1 else 0) + (if (partiallyPostsLedgerTransactionId.asKnown().isPresent) 1 else 0) + (if (postedAt.asKnown().isPresent) 1 else 0) + (if (reversedByLedgerTransactionId.asKnown().isPresent) 1 else 0) + (if (reversesLedgerTransactionId.asKnown().isPresent) 1 else 0) + (status.asKnown().getOrNull()?.validity() ?: 0) + (if (version.asKnown().isPresent) 1 else 0)
    ...
    class LedgerEntryOfTransactionVersion @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun ledgerAccountLockVersion(): Optional<Long> = ledgerAccountLockVersion.getOptional("ledger_account_lock_version")
         ...
         * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun resultingLedgerAccountBalances(): Optional<LedgerBalances> = resultingLedgerAccountBalances.getOptional("resulting_ledger_account_balances")
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [Builder.ledgerAccountLockVersion] with `ledgerAccountLockVersion.orElse(null)`. */
            fun ledgerAccountLockVersion(ledgerAccountLockVersion: Optional<Long>) = ledgerAccountLockVersion(ledgerAccountLockVersion.getOrNull())
            ...
            /** Alias for calling [Builder.resultingLedgerAccountBalances] with `resultingLedgerAccountBalances.orElse(null)`. */
            fun resultingLedgerAccountBalances(resultingLedgerAccountBalances: Optional<LedgerBalances>) = resultingLedgerAccountBalances(resultingLedgerAccountBalances.getOrNull())
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (amount.asKnown().isPresent) 1 else 0) + (if (amountString.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (direction.asKnown().getOrNull()?.validity() ?: 0) + (if (effectiveAt.asKnown().isPresent) 1 else 0) + (if (ledgerAccountCurrency.asKnown().isPresent) 1 else 0) + (if (ledgerAccountCurrencyExponent.asKnown().isPresent) 1 else 0) + (if (ledgerAccountId.asKnown().isPresent) 1 else 0) + (if (ledgerAccountLockVersion.asKnown().isPresent) 1 else 0) + (if (ledgerTransactionId.asKnown().isPresent) 1 else 0) + (if (liveMode.asKnown().isPresent) 1 else 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (if (object_.asKnown().isPresent) 1 else 0) + (resultingLedgerAccountBalances.asKnown().getOrNull()?.validity() ?: 0) + (status.asKnown().getOrNull()?.validity() ?: 0)
