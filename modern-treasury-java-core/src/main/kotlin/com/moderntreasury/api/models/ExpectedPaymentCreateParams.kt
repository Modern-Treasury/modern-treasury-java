...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.expectedPaymentCreate] with
         * `expectedPaymentCreate.orElse(null)`.
         */
        fun expectedPaymentCreate(expectedPaymentCreate: Optional<ExpectedPaymentCreate>) =
            expectedPaymentCreate(expectedPaymentCreate.getOrNull())
    ...
    fun _body(): Optional<ExpectedPaymentCreate> = Optional.ofNullable(expectedPaymentCreate)
