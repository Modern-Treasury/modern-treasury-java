...
class AccountCollectionFlowListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<AccountCollectionFlowListPageAsync> = service.list(nextPageParams())
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AccountCollectionFlowListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, headers, items)

    override fun toString() = "AccountCollectionFlowListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
