...
private constructor(
    ...
    fun originatingLedgerAccountId(): Optional<String> =
        Optional.ofNullable(originatingLedgerAccountId.getNullable("originating_ledger_account_id"))

    /** The ledger account that receives the money movement. */
    fun receivingLedgerAccountId(): Optional<String> =
        Optional.ofNullable(receivingLedgerAccountId.getNullable("receiving_ledger_account_id"))
