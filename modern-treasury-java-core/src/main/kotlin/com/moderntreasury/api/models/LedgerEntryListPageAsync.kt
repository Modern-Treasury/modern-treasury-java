...
class LedgerEntryListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<LedgerEntryListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<LedgerEntry> =
        AutoPagerAsync.from(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerEntryListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, headers, items)

    override fun toString() = "LedgerEntryListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
