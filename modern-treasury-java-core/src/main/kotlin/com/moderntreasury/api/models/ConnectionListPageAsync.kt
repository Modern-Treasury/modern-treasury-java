...
private constructor(
    ...
    fun getNextPageParams(): Optional<ConnectionListParams> {
        ...
        return Optional.of(
            ConnectionListParams.builder().from(params).afterCursor(afterCursor()).build()
        )
    }
    ...
    class Response(
        ...
        fun items(): List<Connection> = items.getOptional("items").getOrNull() ?: listOf()
        ...
        @JsonProperty("items")
        fun _items(): Optional<JsonField<List<Connection>>> = Optional.ofNullable(items)
