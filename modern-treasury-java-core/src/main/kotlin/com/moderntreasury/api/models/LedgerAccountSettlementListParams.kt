...
class LedgerAccountSettlementListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.settledLedgerAccountId] with `settledLedgerAccountId.orElse(null)`. */
        fun settledLedgerAccountId(settledLedgerAccountId: Optional<String>) = settledLedgerAccountId(settledLedgerAccountId.getOrNull())
