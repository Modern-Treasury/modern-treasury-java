...
private constructor(
    ...
    fun paymentOrderUpdate(): Optional<PaymentOrderUpdate> = Optional.ofNullable(paymentOrderUpdate)
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.paymentOrderUpdate] with `paymentOrderUpdate.orElse(null)`.
         */
        fun paymentOrderUpdate(paymentOrderUpdate: Optional<PaymentOrderUpdate>) =
            paymentOrderUpdate(paymentOrderUpdate.getOrNull())
    ...
    fun _body(): Optional<PaymentOrderUpdate> = Optional.ofNullable(paymentOrderUpdate)
