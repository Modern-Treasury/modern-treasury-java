...
class PaymentFlow @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun effectiveDateSelectionEnabled(): Optional<Boolean> = effectiveDateSelectionEnabled.getOptional("effective_date_selection_enabled")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun existingExternalAccountsFilter(): Optional<ExistingExternalAccountsFilter> = existingExternalAccountsFilter.getOptional("existing_external_accounts_filter")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun externalAccountCollection(): Optional<ExternalAccountCollection> = externalAccountCollection.getOptional("external_account_collection")
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun selectedEffectiveDate(): Optional<LocalDate> = selectedEffectiveDate.getOptional("selected_effective_date")
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.existingExternalAccountsFilter] with `existingExternalAccountsFilter.orElse(null)`. */
        fun existingExternalAccountsFilter(existingExternalAccountsFilter: Optional<ExistingExternalAccountsFilter>) = existingExternalAccountsFilter(existingExternalAccountsFilter.getOrNull())
        ...
        /** Alias for calling [Builder.originatingAccountId] with `originatingAccountId.orElse(null)`. */
        fun originatingAccountId(originatingAccountId: Optional<String>) = originatingAccountId(originatingAccountId.getOrNull())
        ...
        fun paymentOrderId(paymentOrderId: Optional<String>) = paymentOrderId(paymentOrderId.getOrNull())
        ...
        /** Alias for calling [Builder.selectedEffectiveDate] with `selectedEffectiveDate.orElse(null)`. */
        fun selectedEffectiveDate(selectedEffectiveDate: Optional<LocalDate>) = selectedEffectiveDate(selectedEffectiveDate.getOrNull())
    ...
    fun validate(): PaymentFlow =
        apply {
            ...
            dueDate()
            effectiveDateSelectionEnabled()
            existingExternalAccountsFilter().ifPresent { it.validate() }
            externalAccountCollection().ifPresent { it.validate() }
            liveMode()
            object_()
            originatingAccountId()
            paymentOrderId()
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (amount.asKnown().isPresent) 1 else 0) + (if (clientToken.asKnown().isPresent) 1 else 0) + (if (counterpartyId.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (currency.asKnown().isPresent) 1 else 0) + (direction.asKnown().getOrNull()?.validity() ?: 0) + (if (dueDate.asKnown().isPresent) 1 else 0) + (if (effectiveDateSelectionEnabled.asKnown().isPresent) 1 else 0) + (existingExternalAccountsFilter.asKnown().getOrNull()?.validity() ?: 0) + (externalAccountCollection.asKnown().getOrNull()?.validity() ?: 0) + (if (liveMode.asKnown().isPresent) 1 else 0) + (if (object_.asKnown().isPresent) 1 else 0) + (if (originatingAccountId.asKnown().isPresent) 1 else 0) + (if (paymentOrderId.asKnown().isPresent) 1 else 0) + (if (receivingAccountId.asKnown().isPresent) 1 else 0) + (if (selectedEffectiveDate.asKnown().isPresent) 1 else 0) + (status.asKnown().getOrNull()?.validity() ?: 0) + (if (updatedAt.asKnown().isPresent) 1 else 0)
