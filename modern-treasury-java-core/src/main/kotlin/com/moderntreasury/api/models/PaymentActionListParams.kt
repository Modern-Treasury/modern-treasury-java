...
class PaymentActionListParams private constructor(
    ...
    fun actionableId(): Optional<String> = Optional.ofNullable(actionableId)

    /** The type of the associated actionable object. One of `payment_order`, `expected_payment`. */
    fun actionableType(): Optional<String> = Optional.ofNullable(actionableType)
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.actionableId] with `actionableId.orElse(null)`. */
        fun actionableId(actionableId: Optional<String>) = actionableId(actionableId.getOrNull())
        ...
        /** Alias for calling [Builder.actionableType] with `actionableType.orElse(null)`. */
        fun actionableType(actionableType: Optional<String>) = actionableType(actionableType.getOrNull())
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                createdAt?.let { it.eq().ifPresent { put("created_at[eq]", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                it.gt().ifPresent { put("created_at[gt]", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                it.gte().ifPresent { put("created_at[gte]", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                it.lt().ifPresent { put("created_at[lt]", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                it.lte().ifPresent { put("created_at[lte]", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
    ...
    class CreatedAt private constructor(
        ...
        fun eq(): Optional<OffsetDateTime> = Optional.ofNullable(eq)
        ...
        class Builder internal constructor() {
            ...
            fun eq(eq: Optional<OffsetDateTime>) = eq(eq.getOrNull())
    ...
    class Status @JsonCreator private constructor(
        ...
        companion object {
            ...
            @JvmField val PROCESSABLE = of("processable")
