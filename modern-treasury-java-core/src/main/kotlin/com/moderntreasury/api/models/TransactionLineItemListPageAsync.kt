...
class TransactionLineItemListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<TransactionLineItemListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<TransactionLineItem> =
        AutoPagerAsync.from(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionLineItemListPageAsync: TransactionLineItemListPageAsync) =
            apply {
                ...
                streamHandlerExecutor = transactionLineItemListPageAsync.streamHandlerExecutor
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TransactionLineItemListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, headers, items)

    override fun toString() = "TransactionLineItemListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
