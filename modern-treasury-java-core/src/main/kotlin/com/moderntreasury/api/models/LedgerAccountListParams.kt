...
class LedgerAccountListParams private constructor(
    ...
    fun availableBalanceAmount(): Optional<AvailableBalanceAmount> = Optional.ofNullable(availableBalanceAmount)
    ...
    /** Use `gt` (>), `gte` (>=), `lt` (<), `lte` (<=), `eq` (=), or `not_eq` (!=) to filter by balance amount. */
    fun pendingBalanceAmount(): Optional<PendingBalanceAmount> = Optional.ofNullable(pendingBalanceAmount)

    fun perPage(): Optional<Long> = Optional.ofNullable(perPage)

    /** Use `gt` (>), `gte` (>=), `lt` (<), `lte` (<=), `eq` (=), or `not_eq` (!=) to filter by balance amount. */
    fun postedBalanceAmount(): Optional<PostedBalanceAmount> = Optional.ofNullable(postedBalanceAmount)
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.availableBalanceAmount] with `availableBalanceAmount.orElse(null)`. */
        fun availableBalanceAmount(availableBalanceAmount: Optional<AvailableBalanceAmount>) = availableBalanceAmount(availableBalanceAmount.getOrNull())
        ...
        fun normalBalance(normalBalance: Optional<TransactionDirection>) = normalBalance(normalBalance.getOrNull())
        ...
        /** Alias for calling [Builder.pendingBalanceAmount] with `pendingBalanceAmount.orElse(null)`. */
        fun pendingBalanceAmount(pendingBalanceAmount: Optional<PendingBalanceAmount>) = pendingBalanceAmount(pendingBalanceAmount.getOrNull())
        ...
        fun postedBalanceAmount(postedBalanceAmount: Optional<PostedBalanceAmount>) = postedBalanceAmount(postedBalanceAmount.getOrNull())
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                availableBalanceAmount?.let { it.eq().ifPresent { put("available_balance_amount[eq]", it.toString()) }
                ...
                balances?.let { it.asOfDate().ifPresent { put("balances[as_of_date]", it.toString()) }
                it.effectiveAt().ifPresent { put("balances[effective_at]", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                it.effectiveAtLowerBound().ifPresent { put("balances[effective_at_lower_bound]", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                it.effectiveAtUpperBound().ifPresent { put("balances[effective_at_upper_bound]", DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it)) }
                it._additionalProperties().keys().forEach { key ->
                    it._additionalProperties().values(key).forEach { value ->
                ...
                pendingBalanceAmount?.let { it.eq().ifPresent { put("pending_balance_amount[eq]", it.toString()) }
                ...
                postedBalanceAmount?.let { it.eq().ifPresent { put("posted_balance_amount[eq]", it.toString()) }
    ...
    class Balances private constructor(
        ...
        fun effectiveAtLowerBound(): Optional<OffsetDateTime> = Optional.ofNullable(effectiveAtLowerBound)

        fun effectiveAtUpperBound(): Optional<OffsetDateTime> = Optional.ofNullable(effectiveAtUpperBound)
        ...
        class Builder internal constructor() {
            ...
            fun effectiveAt(effectiveAt: Optional<OffsetDateTime>) = effectiveAt(effectiveAt.getOrNull())
            ...
            /** Alias for calling [Builder.effectiveAtLowerBound] with `effectiveAtLowerBound.orElse(null)`. */
            fun effectiveAtLowerBound(effectiveAtLowerBound: Optional<OffsetDateTime>) = effectiveAtLowerBound(effectiveAtLowerBound.getOrNull())
