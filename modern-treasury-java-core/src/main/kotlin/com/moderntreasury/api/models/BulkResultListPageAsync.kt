...
class BulkResultListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<BulkResultListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<BulkResult> =
        AutoPagerAsync.from(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BulkResultListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, headers, items)

    override fun toString() = "BulkResultListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
