...
class ExpectedPaymentUpdateParams private constructor(
     ...
     * ```java
     * MyClass myObject = expectedPaymentUpdateParams.reconciliationFilters().convert(MyClass.class);
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = expectedPaymentUpdateParams.reconciliationGroups().convert(MyClass.class);
     * ```
     */
    ...
    class ExpectedPaymentUpdateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = expectedPaymentUpdateRequest.reconciliationFilters().convert(MyClass.class);
         * ```
         */
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```java
         * MyClass myObject = expectedPaymentUpdateRequest.reconciliationGroups().convert(MyClass.class);
         * ```
         */
