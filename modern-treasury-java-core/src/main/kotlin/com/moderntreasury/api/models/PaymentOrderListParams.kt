...
class PaymentOrderListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun createdAtStart(createdAtStart: Optional<LocalDate>) = createdAtStart(createdAtStart.getOrNull())
        ...
        fun effectiveDateEnd(effectiveDateEnd: Optional<LocalDate>) = effectiveDateEnd(effectiveDateEnd.getOrNull())
        ...
        fun effectiveDateStart(effectiveDateStart: Optional<LocalDate>) = effectiveDateStart(effectiveDateStart.getOrNull())
        ...
        fun processAfterEnd(processAfterEnd: Optional<OffsetDateTime>) = processAfterEnd(processAfterEnd.getOrNull())
        ...
        fun processAfterStart(processAfterStart: Optional<OffsetDateTime>) = processAfterStart(processAfterStart.getOrNull())
        ...
        fun referenceNumber(referenceNumber: Optional<String>) = referenceNumber(referenceNumber.getOrNull())
