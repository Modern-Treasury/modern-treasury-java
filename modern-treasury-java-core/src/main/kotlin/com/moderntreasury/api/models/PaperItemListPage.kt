...
private constructor(
    ...
    fun getNextPageParams(): Optional<PaperItemListParams> {
        ...
        return Optional.of(
            PaperItemListParams.builder().from(params).afterCursor(afterCursor()).build()
        )
    }
    ...
    class Response(
        ...
        fun items(): List<PaperItem> = items.getOptional("items").getOrNull() ?: listOf()
        ...
        @JsonProperty("items")
        fun _items(): Optional<JsonField<List<PaperItem>>> = Optional.ofNullable(items)
