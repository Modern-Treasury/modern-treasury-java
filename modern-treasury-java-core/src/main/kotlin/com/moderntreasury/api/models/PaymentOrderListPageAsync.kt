...
private constructor(
    ...
    override fun nextPage(): CompletableFuture<PaymentOrderListPageAsync> =
        service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<PaymentOrder> = AutoPagerAsync.from(this, streamHandlerExecutor)
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentOrderListPageAsync: PaymentOrderListPageAsync) = apply {
            ...
            streamHandlerExecutor = paymentOrderListPageAsync.streamHandlerExecutor
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PaymentOrderListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, streamHandlerExecutor, params, headers, items) /* spotless:on */

    override fun toString() =
        "PaymentOrderListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
