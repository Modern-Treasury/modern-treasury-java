...
private constructor(
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val ACH_TRACE_NUMBER = ReferenceNumberType(JsonField.of("ach_trace_number"))
            ...
            @JvmField val EFT_TRACE_NUMBER = ReferenceNumberType(JsonField.of("eft_trace_number"))
            ...
            @JvmField val JPMC_FIRM_ROOT_ID = ReferenceNumberType(JsonField.of("jpmc_firm_root_id"))
            ...
            @JvmField val PARTIAL_SWIFT_MIR = ReferenceNumberType(JsonField.of("partial_swift_mir"))
            ...
            @JvmField val SIGNET_REQUEST_ID = ReferenceNumberType(JsonField.of("signet_request_id"))

            @JvmField
            val SILVERGATE_PAYMENT_ID = ReferenceNumberType(JsonField.of("silvergate_payment_id"))

            @JvmField val SVB_END_TO_END_ID = ReferenceNumberType(JsonField.of("svb_end_to_end_id"))
            ...
            @JvmField val USBANK_PAYMENT_ID = ReferenceNumberType(JsonField.of("usbank_payment_id"))
            ...
            @JvmField val WELLS_FARGO_UETR = ReferenceNumberType(JsonField.of("wells_fargo_uetr"))
