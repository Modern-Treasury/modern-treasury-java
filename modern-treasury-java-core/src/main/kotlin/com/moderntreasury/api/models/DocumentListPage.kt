...
private constructor(
    ...
    fun getNextPageParams(): Optional<DocumentListParams> {
        ...
        return Optional.of(
            DocumentListParams.builder().from(params).afterCursor(afterCursor()).build()
        )
    }
    ...
    class Response(
        ...
        fun items(): List<Document> = items.getOptional("items").getOrNull() ?: listOf()
        ...
        @JsonProperty("items")
        fun _items(): Optional<JsonField<List<Document>>> = Optional.ofNullable(items)
