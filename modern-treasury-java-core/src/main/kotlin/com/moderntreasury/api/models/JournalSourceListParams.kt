...
private constructor(
    ...
    fun journalEntryId(): Optional<String> = Optional.ofNullable(journalEntryId)

    /** The ID of the journal report */
    fun journalReportId(): Optional<String> = Optional.ofNullable(journalReportId)
    ...
    fun sourceType(): Optional<String> = Optional.ofNullable(sourceType)
    ...
    companion object {
        ...
        @JvmStatic fun none(): JournalSourceListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.journalEntryId] with `journalEntryId.orElse(null)`. */
        fun journalEntryId(journalEntryId: Optional<String>) =
            journalEntryId(journalEntryId.getOrNull())
        ...
        /** Alias for calling [Builder.journalReportId] with `journalReportId.orElse(null)`. */
        fun journalReportId(journalReportId: Optional<String>) =
            journalReportId(journalReportId.getOrNull())
        ...
        fun sourceType(sourceType: Optional<String>) = sourceType(sourceType.getOrNull())
