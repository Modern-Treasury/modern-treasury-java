...
class VirtualAccountListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<VirtualAccountListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<VirtualAccount> =
        AutoPagerAsync.from(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(virtualAccountListPageAsync: VirtualAccountListPageAsync) =
            apply {
                ...
                streamHandlerExecutor = virtualAccountListPageAsync.streamHandlerExecutor
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is VirtualAccountListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, headers, items)

    override fun toString() = "VirtualAccountListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
