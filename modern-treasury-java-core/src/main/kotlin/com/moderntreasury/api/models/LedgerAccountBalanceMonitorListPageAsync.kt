...
class LedgerAccountBalanceMonitorListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<LedgerAccountBalanceMonitorListPageAsync> = service.list(nextPageParams())
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountBalanceMonitorListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, headers, items)

    override fun toString() = "LedgerAccountBalanceMonitorListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
