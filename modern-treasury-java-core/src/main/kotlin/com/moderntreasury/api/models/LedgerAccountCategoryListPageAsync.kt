...
class LedgerAccountCategoryListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<LedgerAccountCategoryListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<LedgerAccountCategory> =
        AutoPagerAsync.from(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ledgerAccountCategoryListPageAsync: LedgerAccountCategoryListPageAsync) =
            apply {
                ...
                streamHandlerExecutor = ledgerAccountCategoryListPageAsync.streamHandlerExecutor
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LedgerAccountCategoryListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, headers, items)

    override fun toString() = "LedgerAccountCategoryListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
