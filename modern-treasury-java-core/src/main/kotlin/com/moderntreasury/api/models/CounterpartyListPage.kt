...
private constructor(
    ...
    fun getNextPageParams(): Optional<CounterpartyListParams> {
        ...
        return Optional.of(
            CounterpartyListParams.builder().from(params).afterCursor(afterCursor()).build()
        )
    }
    ...
    class Response(
        ...
        fun items(): List<Counterparty> = items.getOptional("items").getOrNull() ?: listOf()
        ...
        @JsonProperty("items")
        fun _items(): Optional<JsonField<List<Counterparty>>> = Optional.ofNullable(items)
