...
class PaymentOrderReversalListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<PaymentOrderReversalListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<Reversal> =
        AutoPagerAsync.from(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentOrderReversalListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, headers, items)

    override fun toString() = "PaymentOrderReversalListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
