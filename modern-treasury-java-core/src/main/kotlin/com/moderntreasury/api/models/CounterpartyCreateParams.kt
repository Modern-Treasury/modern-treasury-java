...
private constructor(
    ...
    @JvmSynthetic internal fun _body(): CounterpartyCreateRequest = body
    ...
    private constructor(
         ...
         */
        @Deprecated("deprecated")
        fun ledgerType(): Optional<LedgerType> =
            Optional.ofNullable(ledgerType.getNullable("ledger_type"))
