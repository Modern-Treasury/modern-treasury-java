...
private constructor(
    ...
    private constructor(
         ...
         *   if the server responded with an unexpected value).
         */
        fun legalEntity(): Optional<LegalEntityCreateRequest> =
            legalEntity.getOptional("legal_entity")
    ...
    private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun regulationO(regulationO: Optional<Boolean>) =
                    regulationO(regulationO.getOrNull())
        ...
        private constructor(
            ...
            fun employerCountry(): Optional<String> =
                employerCountry.getOptional("employer_country")
            ...
            fun sourceOfFunds(): Optional<SourceOfFunds> =
                sourceOfFunds.getOptional("source_of_funds")
            ...
            class Builder internal constructor() {
                ...
                fun annualIncome(annualIncome: Optional<Long>) =
                    annualIncome(annualIncome.getOrNull())
                ...
                fun incomeState(incomeState: Optional<String>) =
                    incomeState(incomeState.getOrNull())
                ...
                fun occupation(occupation: Optional<Occupation>) =
                    occupation(occupation.getOrNull())
