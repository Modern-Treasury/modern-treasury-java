...
private constructor(
    ...
    private constructor(
        ...
        fun paymentOrderAsyncCreate(): Optional<PaymentOrderAsyncCreate> =
            Optional.ofNullable(paymentOrderAsyncCreate)

        fun expectedPaymentCreate(): Optional<ExpectedPaymentCreate> =
            Optional.ofNullable(expectedPaymentCreate)
        ...
        fun transactionCreate(): Optional<TransactionCreate> =
            Optional.ofNullable(transactionCreate)
        ...
        private constructor(
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun chargeBearer(): Optional<PaymentOrderUpdate.ChargeBearer> =
                chargeBearer.getOptional("charge_bearer")
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun direction(): Optional<PaymentOrderUpdate.Direction> =
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun fallbackType(): Optional<PaymentOrderUpdate.FallbackType> =
                fallbackType.getOptional("fallback_type")
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun foreignExchangeIndicator(): Optional<PaymentOrderUpdate.ForeignExchangeIndicator> =
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun metadata(): Optional<PaymentOrderUpdate.Metadata> = metadata.getOptional("metadata")
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun priority(): Optional<PaymentOrderUpdate.Priority> = priority.getOptional("priority")
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun receivingAccount(): Optional<PaymentOrderUpdate.ReceivingAccount> =
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun reconciliationStatus(): Optional<PaymentOrderUpdate.ReconciliationStatus> =
                reconciliationStatus.getOptional("reconciliation_status")
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun status(): Optional<PaymentOrderUpdate.Status> = status.getOptional("status")
            ...
            class Builder internal constructor() {
                ...
                fun chargeBearer(chargeBearer: Optional<PaymentOrderUpdate.ChargeBearer>) =
                 ...
                 */
                fun foreignExchangeIndicator(
                    foreignExchangeIndicator: Optional<PaymentOrderUpdate.ForeignExchangeIndicator>
        ...
        private constructor(
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun amountReconciled(): Optional<Long> =
                amountReconciled.getOptional("amount_reconciled")
            ...
            fun amountReconciledDirection():
                Optional<ExpectedPaymentUpdate.AmountReconciledDirection> =
                amountReconciledDirection.getOptional("amount_reconciled_direction")
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun amountUnreconciled(): Optional<Long> =
                amountUnreconciled.getOptional("amount_unreconciled")
            ...
            fun amountUnreconciledDirection():
                Optional<ExpectedPaymentUpdate.AmountUnreconciledDirection> =
                amountUnreconciledDirection.getOptional("amount_unreconciled_direction")
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun direction(): Optional<ExpectedPaymentUpdate.Direction> =
                direction.getOptional("direction")
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun metadata(): Optional<ExpectedPaymentUpdate.Metadata> =
                metadata.getOptional("metadata")
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun status(): Optional<ExpectedPaymentUpdate.Status> = status.getOptional("status")
            ...
            class Builder internal constructor() {
                ...
                /**
                 * Alias for calling [Builder.amountReconciled] with
                 * `amountReconciled.orElse(null)`.
                 */
                fun amountReconciled(amountReconciled: Optional<Long>) =
                    amountReconciled(amountReconciled.getOrNull())
                ...
                /**
                 * Alias for calling [Builder.amountReconciledDirection] with
                 * `amountReconciledDirection.orElse(null)`.
                 */
                fun amountReconciledDirection(
                    amountReconciledDirection:
                        Optional<ExpectedPaymentUpdate.AmountReconciledDirection>
                ) = amountReconciledDirection(amountReconciledDirection.getOrNull())
                ...
                /**
                 * Alias for calling [Builder.amountUnreconciled] with
                 * `amountUnreconciled.orElse(null)`.
                 */
                fun amountUnreconciled(amountUnreconciled: Optional<Long>) =
                    amountUnreconciled(amountUnreconciled.getOrNull())
                ...
                /**
                 * Alias for calling [Builder.amountUnreconciledDirection] with
                 * `amountUnreconciledDirection.orElse(null)`.
                 */
                fun amountUnreconciledDirection(
                    amountUnreconciledDirection:
                        Optional<ExpectedPaymentUpdate.AmountUnreconciledDirection>
                ) = amountUnreconciledDirection(amountUnreconciledDirection.getOrNull())
                ...
                fun direction(direction: Optional<ExpectedPaymentUpdate.Direction>) =
                ...
                fun status(status: Optional<ExpectedPaymentUpdate.Status>) =
            ...
            internal fun validity(): Int =
                (if (amountLowerBound.asKnown().isPresent) 1 else 0) +
                    (if (amountReconciled.asKnown().isPresent) 1 else 0) +
                    (amountReconciledDirection.asKnown().getOrNull()?.validity() ?: 0) +
                    (if (amountUnreconciled.asKnown().isPresent) 1 else 0) +
                    (amountUnreconciledDirection.asKnown().getOrNull()?.validity() ?: 0) +
        ...
        private constructor(
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun metadata(): Optional<TransactionUpdate.Metadata> = metadata.getOptional("metadata")
        ...
        private constructor(
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun ledgerableType(): Optional<LedgerTransactionUpdate.LedgerableType> =
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun metadata(): Optional<LedgerTransactionUpdate.Metadata> =
                metadata.getOptional("metadata")
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun status(): Optional<LedgerTransactionUpdate.Status> = status.getOptional("status")
