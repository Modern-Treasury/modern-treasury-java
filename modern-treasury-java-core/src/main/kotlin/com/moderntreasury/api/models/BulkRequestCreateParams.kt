...
private constructor(
    ...
    private constructor(
        ...
        fun ledgerAccountUpdateRequestWithId(): Optional<LedgerAccountUpdateRequestWithId> =
            Optional.ofNullable(ledgerAccountUpdateRequestWithId)
        ...
        companion object {
            ...
            @JvmStatic fun ofJsonValue(jsonValue: JsonValue) = Resource(jsonValue = jsonValue)
        ...
        private constructor(
            ...
            fun ultimateOriginatingPartyAddress(): Optional<UltimateOriginatingPartyAddress> =
                ultimateOriginatingPartyAddress.getOptional("ultimate_originating_party_address")
            ...
            internal fun validity(): Int =
                (if (amount.asKnown().isPresent) 1 else 0) +
                    ...
                    (ultimateOriginatingPartyAddress.asKnown().getOrNull()?.validity() ?: 0) +
        ...
        private constructor(
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun amountReconciledDirection(): Optional<AmountReconciledDirection> =
             ...
             *   (e.g. if the server responded with an unexpected value).
             */
            fun amountUnreconciledDirection(): Optional<AmountUnreconciledDirection> =
            ...
            class Builder internal constructor() {
                 ...
                 */
                fun amountReconciledDirection(
                    amountReconciledDirection: Optional<AmountReconciledDirection>
                 ...
                 */
                fun amountUnreconciledDirection(
                    amountUnreconciledDirection: Optional<AmountUnreconciledDirection>
