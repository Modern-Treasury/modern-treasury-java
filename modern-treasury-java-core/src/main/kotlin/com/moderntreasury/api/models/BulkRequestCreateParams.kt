...
class BulkRequestCreateParams private constructor(
    ...
    class BulkRequestCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (actionType.asKnown().getOrNull()?.validity() ?: 0) + (resourceType.asKnown().getOrNull()?.validity() ?: 0) + (resources.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0)
    ...
    class Resource private constructor(
        ...
        fun paymentOrderAsyncCreateRequest(): Optional<PaymentOrderAsyncCreateRequest> = Optional.ofNullable(paymentOrderAsyncCreateRequest)

        fun expectedPaymentCreateRequest(): Optional<ExpectedPaymentCreateRequest> = Optional.ofNullable(expectedPaymentCreateRequest)

        fun ledgerTransactionCreateRequest(): Optional<LedgerTransactionCreateRequest> = Optional.ofNullable(ledgerTransactionCreateRequest)

        fun ledgerAccountCreateRequest(): Optional<LedgerAccountCreateRequest> = Optional.ofNullable(ledgerAccountCreateRequest)
        ...
        fun paymentOrderUpdateRequestWithId(): Optional<PaymentOrderUpdateRequestWithId> = Optional.ofNullable(paymentOrderUpdateRequestWithId)

        fun expectedPaymentUpdateRequestWithId(): Optional<ExpectedPaymentUpdateRequestWithId> = Optional.ofNullable(expectedPaymentUpdateRequestWithId)

        fun transactionUpdateRequestWithId(): Optional<TransactionUpdateRequestWithId> = Optional.ofNullable(transactionUpdateRequestWithId)

        fun ledgerTransactionUpdateRequestWithId(): Optional<LedgerTransactionUpdateRequestWithId> = Optional.ofNullable(ledgerTransactionUpdateRequestWithId)

        fun ledgerAccountUpdateRequestWithId(): Optional<LedgerAccountUpdateRequestWithId> = Optional.ofNullable(ledgerAccountUpdateRequestWithId)
         ...
         *     @Override
         *     public Optional<String> visitPaymentOrderAsyncCreateRequest(PaymentOrderAsyncCreateRequest paymentOrderAsyncCreateRequest) {
         *         return Optional.of(paymentOrderAsyncCreateRequest.toString());
         *     }
         *
         *     // ...
         *
        ...
        class PaymentOrderAsyncCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun foreignExchangeContract(): Optional<String> = foreignExchangeContract.getOptional("foreign_exchange_contract")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun foreignExchangeIndicator(): Optional<ForeignExchangeIndicator> = foreignExchangeIndicator.getOptional("foreign_exchange_indicator")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun ledgerTransaction(): Optional<LedgerTransactionCreateRequest> = ledgerTransaction.getOptional("ledger_transaction")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun ledgerTransactionId(): Optional<String> = ledgerTransactionId.getOptional("ledger_transaction_id")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun originatingPartyName(): Optional<String> = originatingPartyName.getOptional("originating_party_name")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun receivingAccount(): Optional<ReceivingAccount> = receivingAccount.getOptional("receiving_account")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun receivingAccountId(): Optional<String> = receivingAccountId.getOptional("receiving_account_id")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun reconciliationStatus(): Optional<ReconciliationStatus> = reconciliationStatus.getOptional("reconciliation_status")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun remittanceInformation(): Optional<String> = remittanceInformation.getOptional("remittance_information")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun sendRemittanceAdvice(): Optional<Boolean> = sendRemittanceAdvice.getOptional("send_remittance_advice")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun statementDescriptor(): Optional<String> = statementDescriptor.getOptional("statement_descriptor")
             ...
             */
            @Deprecated("deprecated")
            fun transactionMonitoringEnabled(): Optional<Boolean> = transactionMonitoringEnabled.getOptional("transaction_monitoring_enabled")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun ultimateOriginatingAccountId(): Optional<String> = ultimateOriginatingAccountId.getOptional("ultimate_originating_account_id")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun ultimateOriginatingPartyAddress(): Optional<UltimateOriginatingPartyAddress> = ultimateOriginatingPartyAddress.getOptional("ultimate_originating_party_address")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun ultimateOriginatingPartyIdentifier(): Optional<String> = ultimateOriginatingPartyIdentifier.getOptional("ultimate_originating_party_identifier")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun ultimateOriginatingPartyName(): Optional<String> = ultimateOriginatingPartyName.getOptional("ultimate_originating_party_name")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun ultimateReceivingPartyIdentifier(): Optional<String> = ultimateReceivingPartyIdentifier.getOptional("ultimate_receiving_party_identifier")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun ultimateReceivingPartyName(): Optional<String> = ultimateReceivingPartyName.getOptional("ultimate_receiving_party_name")
            ...
            class Builder internal constructor() {
                ...
                fun chargeBearer(chargeBearer: Optional<ChargeBearer>) = chargeBearer(chargeBearer.getOrNull())
                ...
                /** Alias for calling [Builder.foreignExchangeContract] with `foreignExchangeContract.orElse(null)`. */
                fun foreignExchangeContract(foreignExchangeContract: Optional<String>) = foreignExchangeContract(foreignExchangeContract.getOrNull())
                ...
                /** Alias for calling [Builder.foreignExchangeIndicator] with `foreignExchangeIndicator.orElse(null)`. */
                fun foreignExchangeIndicator(foreignExchangeIndicator: Optional<ForeignExchangeIndicator>) = foreignExchangeIndicator(foreignExchangeIndicator.getOrNull())
                ...
                /** Alias for calling [Builder.originatingPartyName] with `originatingPartyName.orElse(null)`. */
                fun originatingPartyName(originatingPartyName: Optional<String>) = originatingPartyName(originatingPartyName.getOrNull())
                ...
                fun processAfter(processAfter: Optional<OffsetDateTime>) = processAfter(processAfter.getOrNull())
                ...
                /** Alias for calling [Builder.remittanceInformation] with `remittanceInformation.orElse(null)`. */
                fun remittanceInformation(remittanceInformation: Optional<String>) = remittanceInformation(remittanceInformation.getOrNull())
                ...
                /** Alias for calling [Builder.sendRemittanceAdvice] with `sendRemittanceAdvice.orElse(null)`. */
                fun sendRemittanceAdvice(sendRemittanceAdvice: Optional<Boolean>) = sendRemittanceAdvice(sendRemittanceAdvice.getOrNull())
                ...
                fun statementDescriptor(statementDescriptor: Optional<String>) = statementDescriptor(statementDescriptor.getOrNull())
                ...
                /** Alias for calling [Builder.ultimateOriginatingPartyAddress] with `ultimateOriginatingPartyAddress.orElse(null)`. */
                fun ultimateOriginatingPartyAddress(ultimateOriginatingPartyAddress: Optional<UltimateOriginatingPartyAddress>) = ultimateOriginatingPartyAddress(ultimateOriginatingPartyAddress.getOrNull())
                ...
                /** Alias for calling [Builder.ultimateOriginatingPartyIdentifier] with `ultimateOriginatingPartyIdentifier.orElse(null)`. */
                fun ultimateOriginatingPartyIdentifier(ultimateOriginatingPartyIdentifier: Optional<String>) = ultimateOriginatingPartyIdentifier(ultimateOriginatingPartyIdentifier.getOrNull())
                ...
                /** Alias for calling [Builder.ultimateOriginatingPartyName] with `ultimateOriginatingPartyName.orElse(null)`. */
                fun ultimateOriginatingPartyName(ultimateOriginatingPartyName: Optional<String>) = ultimateOriginatingPartyName(ultimateOriginatingPartyName.getOrNull())
                ...
                /** Alias for calling [Builder.ultimateReceivingPartyIdentifier] with `ultimateReceivingPartyIdentifier.orElse(null)`. */
                fun ultimateReceivingPartyIdentifier(ultimateReceivingPartyIdentifier: Optional<String>) = ultimateReceivingPartyIdentifier(ultimateReceivingPartyIdentifier.getOrNull())
                ...
                /** Alias for calling [Builder.ultimateReceivingPartyName] with `ultimateReceivingPartyName.orElse(null)`. */
                fun ultimateReceivingPartyName(ultimateReceivingPartyName: Optional<String>) = ultimateReceivingPartyName(ultimateReceivingPartyName.getOrNull())
            ...
            fun validate(): PaymentOrderAsyncCreateRequest =
                apply {
                    ...
                    transactionMonitoringEnabled()
                    ultimateOriginatingAccountId()
                    ultimateOriginatingPartyAddress().ifPresent { it.validate() }
                    ultimateOriginatingPartyIdentifier()
                    ultimateOriginatingPartyName()
                    ultimateReceivingPartyIdentifier()
                    ultimateReceivingPartyName()
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (amount.asKnown().isPresent) 1 else 0) + (direction.asKnown().getOrNull()?.validity() ?: 0) + (if (originatingAccountId.asKnown().isPresent) 1 else 0) + (type.asKnown().getOrNull()?.validity() ?: 0) + (accounting.asKnown().getOrNull()?.validity() ?: 0) + (if (accountingCategoryId.asKnown().isPresent) 1 else 0) + (if (accountingLedgerClassId.asKnown().isPresent) 1 else 0) + (chargeBearer.asKnown().getOrNull()?.validity() ?: 0) + (currency.asKnown().getOrNull()?.validity() ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (effectiveDate.asKnown().isPresent) 1 else 0) + (if (expiresAt.asKnown().isPresent) 1 else 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (fallbackType.asKnown().getOrNull()?.validity() ?: 0) + (if (foreignExchangeContract.asKnown().isPresent) 1 else 0) + (foreignExchangeIndicator.asKnown().getOrNull()?.validity() ?: 0) + (ledgerTransaction.asKnown().getOrNull()?.validity() ?: 0) + (if (ledgerTransactionId.asKnown().isPresent) 1 else 0) + (lineItems.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (if (nsfProtected.asKnown().isPresent) 1 else 0) + (if (originatingPartyName.asKnown().isPresent) 1 else 0) + (priority.asKnown().getOrNull()?.validity() ?: 0) + (if (processAfter.asKnown().isPresent) 1 else 0) + (if (purpose.asKnown().isPresent) 1 else 0) + (receivingAccount.asKnown().getOrNull()?.validity() ?: 0) + (if (receivingAccountId.asKnown().isPresent) 1 else 0) + (reconciliationStatus.asKnown().getOrNull()?.validity() ?: 0) + (if (remittanceInformation.asKnown().isPresent) 1 else 0) + (if (sendRemittanceAdvice.asKnown().isPresent) 1 else 0) + (if (statementDescriptor.asKnown().isPresent) 1 else 0) + (subtype.asKnown().getOrNull()?.validity() ?: 0) + (if (transactionMonitoringEnabled.asKnown().isPresent) 1 else 0) + (if (ultimateOriginatingAccountId.asKnown().isPresent) 1 else 0) + (ultimateOriginatingPartyAddress.asKnown().getOrNull()?.validity() ?: 0) + (if (ultimateOriginatingPartyIdentifier.asKnown().isPresent) 1 else 0) + (if (ultimateOriginatingPartyName.asKnown().isPresent) 1 else 0) + (if (ultimateReceivingPartyIdentifier.asKnown().isPresent) 1 else 0) + (if (ultimateReceivingPartyName.asKnown().isPresent) 1 else 0)
            ...
            class LineItemRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (if (amount.asKnown().isPresent) 1 else 0) + (if (accountingCategoryId.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0)
            ...
            class ReceivingAccount @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun accountDetails(): Optional<List<AccountDetail>> = accountDetails.getOptional("account_details")
                ...
                /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun contactDetails(): Optional<List<ContactDetailCreateRequest>> = contactDetails.getOptional("contact_details")
                 ...
                 * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun ledgerAccount(): Optional<LedgerAccountCreateRequest> = ledgerAccount.getOptional("ledger_account")
                 ...
                 * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
                 */
                fun plaidProcessorToken(): Optional<String> = plaidProcessorToken.getOptional("plaid_processor_token")

                /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                fun routingDetails(): Optional<List<RoutingDetail>> = routingDetails.getOptional("routing_details")
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (accountDetails.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (accountType.asKnown().getOrNull()?.validity() ?: 0) + (contactDetails.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (ledgerAccount.asKnown().getOrNull()?.validity() ?: 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (partyAddress.asKnown().getOrNull()?.validity() ?: 0) + (if (partyIdentifier.asKnown().isPresent) 1 else 0) + (if (partyName.asKnown().isPresent) 1 else 0) + (partyType.asKnown().getOrNull()?.validity() ?: 0) + (if (plaidProcessorToken.asKnown().isPresent) 1 else 0) + (routingDetails.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
                ...
                class AccountDetail @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                    ...
                    /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
                    fun accountNumberType(): Optional<AccountNumberType> = accountNumberType.getOptional("account_number_type")
                     ...
                     */
                    @JvmSynthetic
                    internal fun validity(): Int = (if (accountNumber.asKnown().isPresent) 1 else 0) + (accountNumberType.asKnown().getOrNull()?.validity() ?: 0)
                ...
                class RoutingDetail @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                     ...
                     */
                    @JvmSynthetic
                    internal fun validity(): Int = (if (routingNumber.asKnown().isPresent) 1 else 0) + (routingNumberType.asKnown().getOrNull()?.validity() ?: 0) + (paymentType.asKnown().getOrNull()?.validity() ?: 0)
            ...
            class ReconciliationStatus @JsonCreator private constructor(
                ...
                companion object {
                    ...
                    @JvmField val TENTATIVELY_RECONCILED = of("tentatively_reconciled")

                    @JvmField val RECONCILED = of("reconciled")

                    @JvmStatic fun of(value: String) = ReconciliationStatus(JsonField.of(value))
                }
            ...
            class UltimateOriginatingPartyAddress @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (if (country.asKnown().isPresent) 1 else 0) + (if (line1.asKnown().isPresent) 1 else 0) + (if (line2.asKnown().isPresent) 1 else 0) + (if (locality.asKnown().isPresent) 1 else 0) + (if (postalCode.asKnown().isPresent) 1 else 0) + (if (region.asKnown().isPresent) 1 else 0)
        ...
        class ExpectedPaymentCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun amountReconciled(): Optional<Long> = amountReconciled.getOptional("amount_reconciled")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun amountReconciledDirection(): Optional<AmountReconciledDirection> = amountReconciledDirection.getOptional("amount_reconciled_direction")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun amountUnreconciled(): Optional<Long> = amountUnreconciled.getOptional("amount_unreconciled")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun amountUnreconciledDirection(): Optional<AmountUnreconciledDirection> = amountUnreconciledDirection.getOptional("amount_unreconciled_direction")
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun reconciliationRuleVariables(): Optional<List<ReconciliationRule>> = reconciliationRuleVariables.getOptional("reconciliation_rule_variables")
            ...
            class Builder internal constructor() {
                ...
                /** Alias for calling [Builder.amountLowerBound] with `amountLowerBound.orElse(null)`. */
                fun amountLowerBound(amountLowerBound: Optional<Long>) = amountLowerBound(amountLowerBound.getOrNull())
                ...
                /** Alias for calling [Builder.amountReconciled] with `amountReconciled.orElse(null)`. */
                fun amountReconciled(amountReconciled: Optional<Long>) = amountReconciled(amountReconciled.getOrNull())
                ...
                /** Alias for calling [Builder.amountReconciledDirection] with `amountReconciledDirection.orElse(null)`. */
                fun amountReconciledDirection(amountReconciledDirection: Optional<AmountReconciledDirection>) = amountReconciledDirection(amountReconciledDirection.getOrNull())
                ...
                /** Alias for calling [Builder.amountUnreconciled] with `amountUnreconciled.orElse(null)`. */
                fun amountUnreconciled(amountUnreconciled: Optional<Long>) = amountUnreconciled(amountUnreconciled.getOrNull())
                ...
                /** Alias for calling [Builder.amountUnreconciledDirection] with `amountUnreconciledDirection.orElse(null)`. */
                fun amountUnreconciledDirection(amountUnreconciledDirection: Optional<AmountUnreconciledDirection>) = amountUnreconciledDirection(amountUnreconciledDirection.getOrNull())
                ...
                /** Alias for calling [Builder.amountUpperBound] with `amountUpperBound.orElse(null)`. */
                fun amountUpperBound(amountUpperBound: Optional<Long>) = amountUpperBound(amountUpperBound.getOrNull())
                ...
                fun dateLowerBound(dateLowerBound: Optional<LocalDate>) = dateLowerBound(dateLowerBound.getOrNull())
                ...
                fun dateUpperBound(dateUpperBound: Optional<LocalDate>) = dateUpperBound(dateUpperBound.getOrNull())
                ...
                /** Alias for calling [Builder.reconciliationRuleVariables] with `reconciliationRuleVariables.orElse(null)`. */
                fun reconciliationRuleVariables(reconciliationRuleVariables: Optional<List<ReconciliationRule>>) = reconciliationRuleVariables(reconciliationRuleVariables.getOrNull())
            ...
            fun validate(): ExpectedPaymentCreateRequest =
                apply {
                    ...
                    amountLowerBound()
                    amountReconciled()
                    amountReconciledDirection().ifPresent { it.validate() }
                    amountUnreconciled()
                    amountUnreconciledDirection().ifPresent { it.validate() }
                    amountUpperBound()
                    counterpartyId()
                    currency().ifPresent { it.validate() }
                    dateLowerBound()
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (amountLowerBound.asKnown().isPresent) 1 else 0) + (if (amountReconciled.asKnown().isPresent) 1 else 0) + (amountReconciledDirection.asKnown().getOrNull()?.validity() ?: 0) + (if (amountUnreconciled.asKnown().isPresent) 1 else 0) + (amountUnreconciledDirection.asKnown().getOrNull()?.validity() ?: 0) + (if (amountUpperBound.asKnown().isPresent) 1 else 0) + (if (counterpartyId.asKnown().isPresent) 1 else 0) + (currency.asKnown().getOrNull()?.validity() ?: 0) + (if (dateLowerBound.asKnown().isPresent) 1 else 0) + (if (dateUpperBound.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (direction.asKnown().getOrNull()?.validity() ?: 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (if (internalAccountId.asKnown().isPresent) 1 else 0) + (ledgerTransaction.asKnown().getOrNull()?.validity() ?: 0) + (if (ledgerTransactionId.asKnown().isPresent) 1 else 0) + (lineItems.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (reconciliationRuleVariables.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (remittanceInformation.asKnown().isPresent) 1 else 0) + (if (statementDescriptor.asKnown().isPresent) 1 else 0) + (type.asKnown().getOrNull()?.validity() ?: 0)
            ...
            class AmountReconciledDirection @JsonCreator private constructor(
                ...
                companion object {
                    ...
                    @JvmStatic fun of(value: String) = AmountReconciledDirection(JsonField.of(value))
                }
            ...
            class AmountUnreconciledDirection @JsonCreator private constructor(
                ...
                companion object {
                    ...
                    @JvmStatic fun of(value: String) = AmountUnreconciledDirection(JsonField.of(value))
                }
        ...
        class PaymentOrderUpdateRequestWithId @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun originatingAccountId(): Optional<String> = originatingAccountId.getOptional("originating_account_id")
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (accounting.asKnown().getOrNull()?.validity() ?: 0) + (if (accountingCategoryId.asKnown().isPresent) 1 else 0) + (if (accountingLedgerClassId.asKnown().isPresent) 1 else 0) + (if (amount.asKnown().isPresent) 1 else 0) + (chargeBearer.asKnown().getOrNull()?.validity() ?: 0) + (if (counterpartyId.asKnown().isPresent) 1 else 0) + (currency.asKnown().getOrNull()?.validity() ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (direction.asKnown().getOrNull()?.validity() ?: 0) + (if (effectiveDate.asKnown().isPresent) 1 else 0) + (if (expiresAt.asKnown().isPresent) 1 else 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (fallbackType.asKnown().getOrNull()?.validity() ?: 0) + (if (foreignExchangeContract.asKnown().isPresent) 1 else 0) + (foreignExchangeIndicator.asKnown().getOrNull()?.validity() ?: 0) + (lineItems.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (if (nsfProtected.asKnown().isPresent) 1 else 0) + (if (originatingAccountId.asKnown().isPresent) 1 else 0) + (if (originatingPartyName.asKnown().isPresent) 1 else 0) + (priority.asKnown().getOrNull()?.validity() ?: 0) + (if (processAfter.asKnown().isPresent) 1 else 0) + (if (purpose.asKnown().isPresent) 1 else 0) + (receivingAccount.asKnown().getOrNull()?.validity() ?: 0) + (if (receivingAccountId.asKnown().isPresent) 1 else 0) + (reconciliationStatus.asKnown().getOrNull()?.validity() ?: 0) + (if (remittanceInformation.asKnown().isPresent) 1 else 0) + (if (sendRemittanceAdvice.asKnown().isPresent) 1 else 0) + (if (statementDescriptor.asKnown().isPresent) 1 else 0) + (status.asKnown().getOrNull()?.validity() ?: 0) + (subtype.asKnown().getOrNull()?.validity() ?: 0) + (type.asKnown().getOrNull()?.validity() ?: 0) + (if (ultimateOriginatingPartyIdentifier.asKnown().isPresent) 1 else 0) + (if (ultimateOriginatingPartyName.asKnown().isPresent) 1 else 0) + (if (ultimateReceivingPartyIdentifier.asKnown().isPresent) 1 else 0) + (if (ultimateReceivingPartyName.asKnown().isPresent) 1 else 0)
        ...
        class ExpectedPaymentUpdateRequestWithId @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (amountLowerBound.asKnown().isPresent) 1 else 0) + (if (amountReconciled.asKnown().isPresent) 1 else 0) + (amountReconciledDirection.asKnown().getOrNull()?.validity() ?: 0) + (if (amountUnreconciled.asKnown().isPresent) 1 else 0) + (amountUnreconciledDirection.asKnown().getOrNull()?.validity() ?: 0) + (if (amountUpperBound.asKnown().isPresent) 1 else 0) + (if (counterpartyId.asKnown().isPresent) 1 else 0) + (currency.asKnown().getOrNull()?.validity() ?: 0) + (if (dateLowerBound.asKnown().isPresent) 1 else 0) + (if (dateUpperBound.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (direction.asKnown().getOrNull()?.validity() ?: 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (if (internalAccountId.asKnown().isPresent) 1 else 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (reconciliationRuleVariables.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (remittanceInformation.asKnown().isPresent) 1 else 0) + (if (statementDescriptor.asKnown().isPresent) 1 else 0) + (status.asKnown().getOrNull()?.validity() ?: 0) + (type.asKnown().getOrNull()?.validity() ?: 0)
        ...
        class TransactionUpdateRequestWithId @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0)
        ...
        class LedgerTransactionUpdateRequestWithId @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
             ...
             * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun ledgerEntries(): Optional<List<LedgerEntryCreateRequest>> = ledgerEntries.getOptional("ledger_entries")
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (effectiveAt.asKnown().isPresent) 1 else 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (ledgerEntries.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (ledgerableId.asKnown().isPresent) 1 else 0) + (ledgerableType.asKnown().getOrNull()?.validity() ?: 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (status.asKnown().getOrNull()?.validity() ?: 0)
        ...
        class LedgerAccountUpdateRequestWithId @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (externalId.asKnown().isPresent) 1 else 0) + (metadata.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0)
