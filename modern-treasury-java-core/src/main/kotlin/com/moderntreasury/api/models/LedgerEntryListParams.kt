...
class LedgerEntryListParams private constructor(
    ...
    fun ledgerAccountLockVersion(): Optional<LedgerAccountLockVersion> = Optional.ofNullable(ledgerAccountLockVersion)
    ...
    class Builder internal constructor() {
        ...
        fun ledgerAccountLockVersion(ledgerAccountLockVersion: Optional<LedgerAccountLockVersion>) = ledgerAccountLockVersion(ledgerAccountLockVersion.getOrNull())
        ...
        /** Alias for calling [Builder.ledgerAccountPayoutId] with `ledgerAccountPayoutId.orElse(null)`. */
        fun ledgerAccountPayoutId(ledgerAccountPayoutId: Optional<String>) = ledgerAccountPayoutId(ledgerAccountPayoutId.getOrNull())
        ...
        /** Alias for calling [Builder.ledgerAccountStatementId] with `ledgerAccountStatementId.orElse(null)`. */
        fun ledgerAccountStatementId(ledgerAccountStatementId: Optional<String>) = ledgerAccountStatementId(ledgerAccountStatementId.getOrNull())
