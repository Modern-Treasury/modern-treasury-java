...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun partyAddress(partyAddress: Optional<Address>) =
                partyAddress(partyAddress.getOrNull())
            ...
            /**
             * Alias for calling [Builder.verificationSource] with
             * `verificationSource.orElse(null)`.
             */
