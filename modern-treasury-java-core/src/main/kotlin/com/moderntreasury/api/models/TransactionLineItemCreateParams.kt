...
class TransactionLineItemCreateParams private constructor(
    ...
    class TransactionLineItemCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (amount.asKnown().isPresent) 1 else 0) + (if (expectedPaymentId.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0)
