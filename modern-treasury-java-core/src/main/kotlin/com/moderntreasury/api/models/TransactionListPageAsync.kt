...
class TransactionListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<TransactionListPageAsync> = service.list(nextPageParams())
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is TransactionListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, headers, items)

    override fun toString() = "TransactionListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
