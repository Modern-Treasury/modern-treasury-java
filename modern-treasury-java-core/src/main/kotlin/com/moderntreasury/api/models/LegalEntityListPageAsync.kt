...
class LegalEntityListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<LegalEntityListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<LegalEntity> =
        AutoPagerAsync.from(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LegalEntityListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && headers == other.headers && items == other.items
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, headers, items)

    override fun toString() = "LegalEntityListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, headers=$headers, items=$items}"
}
