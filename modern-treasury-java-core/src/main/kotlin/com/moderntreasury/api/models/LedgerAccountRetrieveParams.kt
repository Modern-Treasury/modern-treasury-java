...
class LedgerAccountRetrieveParams private constructor(
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                it.asOfLockVersion().ifPresent { put("balances[as_of_lock_version]", it.toString()) }
    ...
    class Balances private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun asOfLockVersion(asOfLockVersion: Optional<Long>) = asOfLockVersion(asOfLockVersion.getOrNull())
