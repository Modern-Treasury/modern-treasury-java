...
private constructor(
     ...
     *   the server responded with an unexpected value).
     */
    fun documents(): Optional<List<DocumentCreate>> = body.documents()
    ...
    private constructor(
         ...
         *   if the server responded with an unexpected value).
         */
        fun documents(): Optional<List<DocumentCreate>> = documents.value.getOptional("documents")
         ...
         *   if the server responded with an unexpected value).
         */
        fun lineItems(): Optional<List<LineItem>> = lineItems.value.getOptional("line_items")
