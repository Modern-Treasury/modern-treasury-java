...
private constructor(
    ...
    class IdType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val IL_CN = of("il_cn")

            @JvmField val IL_PIN = of("il_pin")

            @JvmField val IM_TRN = of("im_trn")
            ...
            @JvmField val JE_SSN = of("je_ssn")

            @JvmField val JE_TIN = of("je_tin")

            @JvmField val JM_TRN = of("jm_trn")

            @JvmField val JO_TIN = of("jo_tin")
            ...
            @JvmField val KG_PIN = of("kg_pin")

            @JvmField val KN_TIN = of("kn_tin")
            ...
            @JvmField val KW_CID = of("kw_cid")

            @JvmField val KZ_BIN = of("kz_bin")

            @JvmField val KZ_IIN = of("kz_iin")

            @JvmField val LA_TIN = of("la_tin")

            @JvmField val LC_TIN = of("lc_tin")

            @JvmField val LI_PEID = of("li_peid")

            @JvmField val LK_TIN = of("lk_tin")

            @JvmField val LS_TIN = of("ls_tin")
            ...
            @JvmField val MD_IDNP = of("md_idnp")

            @JvmField val ME_JMBG = of("me_jmbg")

            @JvmField val ME_PIB = of("me_pib")

            @JvmField val MG_NIF = of("mg_nif")

            @JvmField val MH_SSN = of("mh_ssn")

            @JvmField val MO_BIR = of("mo_bir")

            @JvmField val MO_TIN_B = of("mo_tin_b")

            @JvmField val MO_TIN_I = of("mo_tin_i")
            ...
            @JvmField val MU_TAN = of("mu_tan")

            @JvmField val MW_TPIN = of("mw_tpin")
            ...
            @JvmField val MY_NPC = of("my_npc")

            @JvmField val MY_NRIC = of("my_nric")

            @JvmField val MY_TIN_B = of("my_tin_b")

            @JvmField val MZ_NUIT = of("mz_nuit")

            @JvmField val NA_TIN = of("na_tin")
            ...
            @JvmField val NR_TIN = of("nr_tin")

            @JvmField val NZ_IRD = of("nz_ird")

            @JvmField val OM_CID = of("om_cid")

            @JvmField val PA_CEDULA = of("pa_cedula")

            @JvmField val PA_RUC = of("pa_ruc")

            @JvmField val PASSPORT = of("passport")

            @JvmField val PE_RUC = of("pe_ruc")

            @JvmField val PG_TIN = of("pg_tin")
            ...
            @JvmField val QA_QID = of("qa_qid")

            @JvmField val QA_TIN = of("qa_tin")

            @JvmField val RO_CNP = of("ro_cnp")

            @JvmField val RO_CUI = of("ro_cui")

            @JvmField val RW_TIN = of("rw_tin")
            ...
            @JvmField val SL_TIN = of("sl_tin")

            @JvmField val SM_SSI = of("sm_ssi")

            @JvmField val SZ_TIN = of("sz_tin")

            @JvmField val TG_NIF = of("tg_nif")

            @JvmField val TH_JID = of("th_jid")

            @JvmField val TH_PIN = of("th_pin")

            @JvmField val TJ_INN = of("tj_inn")

            @JvmField val TO_TIN = of("to_tin")

            @JvmField val TR_TCKN = of("tr_tckn")

            @JvmField val TT_BIR = of("tt_bir")

            @JvmField val TW_NRIC = of("tw_nric")

            @JvmField val TW_UBN = of("tw_ubn")
            ...
            @JvmField val UZ_INN = of("uz_inn")

            @JvmField val UZ_PIN = of("uz_pin")

            @JvmField val VN_TIN = of("vn_tin")

            @JvmField val ZA_TRN = of("za_trn")

            @JvmField val ZA_VAT = of("za_vat")

            @JvmField val ZM_TPIN = of("zm_tpin")
