...
class PaymentActionCreateParams private constructor(
     ...
     */
    fun actionableId(): Optional<String> = body.actionableId()
    ...
    class PaymentActionCreateRequest @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (type.asKnown().isPresent) 1 else 0) + (if (actionableId.asKnown().isPresent) 1 else 0) + (if (actionableType.asKnown().isPresent) 1 else 0) + (if (internalAccountId.asKnown().isPresent) 1 else 0)
