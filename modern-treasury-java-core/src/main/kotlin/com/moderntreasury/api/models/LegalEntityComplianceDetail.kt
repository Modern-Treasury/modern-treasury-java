...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.tokenIssuedAt] with `tokenIssuedAt.orElse(null)`. */
        fun tokenIssuedAt(tokenIssuedAt: Optional<OffsetDateTime>) =
            tokenIssuedAt(tokenIssuedAt.getOrNull())
        ...
        /** Alias for calling [Builder.tokenUrl] with `tokenUrl.orElse(null)`. */
        fun tokenUrl(tokenUrl: Optional<String>) = tokenUrl(tokenUrl.getOrNull())
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (tokenIssuedAt.asKnown().isPresent) 1 else 0) +
            (if (tokenUrl.asKnown().isPresent) 1 else 0) +
            (if (updatedAt.asKnown().isPresent) 1 else 0) +
            (if (entityValidated.asKnown().isPresent) 1 else 0) +
