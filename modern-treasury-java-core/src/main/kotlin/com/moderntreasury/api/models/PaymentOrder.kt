...
private constructor(
     ...
     *   the server responded with an unexpected value).
     */
    fun complianceRuleMetadata(): Optional<ComplianceRuleMetadata> =
        Optional.ofNullable(complianceRuleMetadata.getNullable("compliance_rule_metadata"))
     ...
     *   the server responded with an unexpected value).
     */
    fun decisionId(): Optional<String> = Optional.ofNullable(decisionId.getNullable("decision_id"))
    ...
    fun ultimateOriginatingAccount(): Optional<UltimateOriginatingAccount> =
        Optional.ofNullable(ultimateOriginatingAccount.getNullable("ultimate_originating_account"))
    ...
    fun ultimateReceivingPartyName(): Optional<String> =
        Optional.ofNullable(ultimateReceivingPartyName.getNullable("ultimate_receiving_party_name"))
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.complianceRuleMetadata] with
         * `complianceRuleMetadata.orElse(null)`.
         */
        ...
        /** Alias for calling [Builder.decisionId] with `decisionId.orElse(null)`. */
