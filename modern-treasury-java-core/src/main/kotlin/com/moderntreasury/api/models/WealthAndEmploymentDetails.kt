...
class WealthAndEmploymentDetails @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun employmentStatus(): Optional<EmploymentStatus> = employmentStatus.getOptional("employment_status")
    ...
    class Builder internal constructor() {
        ...
        fun employerCountry(employerCountry: Optional<String>) = employerCountry(employerCountry.getOrNull())
        ...
        fun employerState(employerState: Optional<String>) = employerState(employerState.getOrNull())
        ...
        fun incomeCountry(incomeCountry: Optional<String>) = incomeCountry(incomeCountry.getOrNull())
        ...
        fun incomeSource(incomeSource: Optional<IncomeSource>) = incomeSource(incomeSource.getOrNull())
        ...
        fun sourceOfFunds(sourceOfFunds: Optional<SourceOfFunds>) = sourceOfFunds(sourceOfFunds.getOrNull())
        ...
        fun wealthSource(wealthSource: Optional<WealthSource>) = wealthSource(wealthSource.getOrNull())
