...
private constructor(
     ...
     *   the server responded with an unexpected value).
     */
    fun invoiceLineItems(): Optional<List<InvoiceLineItemCreate>> = body.invoiceLineItems()
    ...
    class Builder internal constructor() {
        ...
        fun invoiceLineItems(invoiceLineItems: Optional<List<InvoiceLineItemCreate>>) =
    ...
    private constructor(
         ...
         *   if the server responded with an unexpected value).
         */
        fun invoiceLineItems(): Optional<List<InvoiceLineItemCreate>> =
