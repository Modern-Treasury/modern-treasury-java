    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (outcome.asKnown().getOrNull()?.validity() ?: 0) +
                ...
                (verificationCategory.asKnown().getOrNull()?.validity() ?: 0) +
                (if (verificationMethod.asKnown().isPresent) 1 else 0) +
                (if (verificationTime.asKnown().isPresent) 1 else 0) +
        ...
        class Vendor @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField val SUMSUB = of("sumsub")

                @JvmField val VERIFF = of("veriff")
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField val LEGAL_NAME = of("legal_name")

                @JvmField val DATE_OF_BIRTH = of("date_of_birth")

                @JvmField val ADDRESS = of("address")

                @JvmField val GOVERNMENT_ID_NUMBER = of("government_id_number")

                @JvmField val ADVERSE_MEDIA = of("adverse_media")

                @JvmStatic fun of(value: String) = VerificationCategory(JsonField.of(value))
            }
