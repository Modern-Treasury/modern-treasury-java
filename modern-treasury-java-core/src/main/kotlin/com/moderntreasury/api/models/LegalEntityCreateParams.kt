...
class LegalEntityCreateParams private constructor(
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun businessDescription(): Optional<String> = body.businessDescription()
     ...
     * ```java
     * MyClass myObject = legalEntityCreateParams.complianceDetails().convert(MyClass.class);
     * ```
     */
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun countryOfIncorporation(): Optional<String> = body.countryOfIncorporation()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun expectedActivityVolume(): Optional<Long> = body.expectedActivityVolume()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun industryClassifications(): Optional<List<LegalEntityIndustryClassification>> = body.industryClassifications()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun intendedUse(): Optional<String> = body.intendedUse()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun legalEntityAssociations(): Optional<List<LegalEntityAssociationInlineCreate>> = body.legalEntityAssociations()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun listedExchange(): Optional<String> = body.listedExchange()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun operatingJurisdictions(): Optional<List<String>> = body.operatingJurisdictions()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun primarySocialMediaSites(): Optional<List<String>> = body.primarySocialMediaSites()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun regulators(): Optional<List<LegalEntityRegulator>> = body.regulators()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun thirdPartyVerifications(): Optional<List<ThirdPartyVerification>> = body.thirdPartyVerifications()
     ...
     * @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun tickerSymbol(): Optional<String> = body.tickerSymbol()

    /** @throws ModernTreasuryInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun wealthAndEmploymentDetails(): Optional<WealthAndEmploymentDetails> = body.wealthAndEmploymentDetails()
