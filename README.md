...
[![Maven Central](https://img.shields.io/maven-central/v/com.moderntreasury.api/modern-treasury-java)](https://central.sonatype.com/artifact/com.moderntreasury.api/modern-treasury-java/2.13.0)
...
```kotlin
implementation("com.moderntreasury:modern-treasury-java:2.13.0")
```
