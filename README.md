...
[![Maven Central](https://img.shields.io/maven-central/v/com.moderntreasury.api/modern-treasury-java)](https://central.sonatype.com/artifact/com.moderntreasury.api/modern-treasury-java/7.4.0)
[![javadoc](https://javadoc.io/badge2/com.moderntreasury.api/modern-treasury-java/7.4.0/javadoc.svg)](https://javadoc.io/doc/com.moderntreasury.api/modern-treasury-java/7.4.0)
...
The REST API documentation can be found on [docs.moderntreasury.com](https://docs.moderntreasury.com). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.moderntreasury.api/modern-treasury-java/7.4.0).
...
```kotlin
implementation("com.moderntreasury:modern-treasury-java:7.4.0")
```
