...
[![Maven Central](https://img.shields.io/maven-central/v/com.moderntreasury.api/modern-treasury-java)](https://central.sonatype.com/artifact/com.moderntreasury.api/modern-treasury-java/1.1.0)
...
We expect some breaking changes to rarely-used areas of the SDK, and appreciate your [feedback](https://www.github.com/Modern-Treasury/modern-treasury-java/issues).
...
```kotlin
implementation("com.moderntreasury.api:modern-treasury-java:1.1.0")
```
